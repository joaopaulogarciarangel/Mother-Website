! function() {
  ...
  function p(t, e) {
    ...
    const i = function(t, e) {
      ...
      return Object.keys(n).concat(Object.keys(i)).forEach((function t(e) {
        if (n[e]) return r[e] = [];
        if (!(e in r)) {
          r[e] = null;
  ...
  function v(t) {
    ...
    for (const t in r) {
      const e = r[t],
        o = e.parent;
      if (!t || "string" != typeof o || !n[o] && !r[o] || !b(e, i)) return null
    }
    return e
  }
  ...
  function j(t, e) {
    ...
    return e ? function(t, e, n) {
      ...
      return !1
    }(i, n.name, e) : (i.missing.add(n.name), !0)
  }

  function O(t, e) {
    if ("object" != typeof t) return !1;
    if ("string" != typeof e && (e = t.provider || ""), w && !e && !t.prefix) {
      let e = !1;
  ...
  function P(t, e, n, i) {
    ...
    return "function" == typeof i && h.push(i), setTimeout(y),
      function() {
        return {
          startTime: c,
          payload: e,
          ...
          t.pendingCallbacksFlag || (t.pendingCallbacksFlag = !0, setTimeout((() => {
            ...
            e.forEach((e => {
              ...
              o.pending = o.pending.filter((e => {
                ...
                return !1
              })), o.pending.length !== s && (n || E([t], e.id), e.callback(o.loaded.slice(0), o.missing.slice(0), o.pending.slice(0), e.abort))
            }))
          })))
        }(t)
    })))
  ...
  function X(t, e) {
    t.iconsToLoad ? t.iconsToLoad = t.iconsToLoad.concat(e).sort() : t.iconsToLoad = e, t.iconsQueueFlag || (t.iconsQueueFlag = !0, setTimeout((() => {
      ...
      const r = t.loadIcon;
      if (t.loadIcons && (i.length > 1 || !r)) return void W(t.loadIcons(i, n, e), (e => {
        K(t, i, e)
      }));
      if (r) return void i.forEach((i => {
        W(r(i, n, e), (e => {
          K(t, [i], e ? {
            prefix: n,
            icons: {
  ...
  const Y = (t, e) => {
      ...
      return i.pending.forEach((t => {
        ...
        const {
          ...
          prefix: n,
          name: i
        } = t, o = y(e, n), s = o.pendingIcons || (o.pendingIcons = new Set);
  ...
  function st(t, e) {
    ...
    const a = r.width,
      ...
      f = s.height;
    let d, h;
    null === a ? (h = null === u ? "1em" : "auto" === u ? f : u, d = rt(h, l / f)) : (d = "auto" === a ? l : a, h = null === u ? rt(d, f / l) : "auto" === u ? f : u);
    const p = {},
      g = (t, e) => {
        ot(e) || (p[t] = e.toString())
      };
  ...
  function mt(t, e) {
    let n = Array.from(t.childNodes).find((t => t.hasAttribute && t.hasAttribute(gt)));
    n || (n = document.createElement("style"), n.setAttribute(gt, gt), t.appendChild(n)), n.textContent = ":host{display:inline-block;vertical-align:" + (e ? "-0.125em" : "0") + "}span,svg{display:block;margin:auto}" + bt
  }
  const yt = {
  ...
  function Ct(t, e) {
    ...
    if ("svg" === s) c = function(t) {
      ...
      let r = t.body; - 1 !== r.indexOf("<a") && (r += "\x3c!-- " + Date.now() + " --\x3e");
      ...
      o = class extends n {
        ...
        _check() {
          ...
          t.attrMode === n && ! function(t, e) {
            for (const n in c)
              if (t[n] !== e[n]) return !0;
            return !1
          }(t.customisations, i) && Ot(this._shadowRoot) || this._renderIcon(t.icon, i, n)
        }
        _iconChanged(t) {
          ...
          e.data ? this._gotIconData(e) : this._state = It(e, this._state.inline, this._state)
        }
        _forceRender() {
        ...
        _renderIcon(t, e, n) {
          const i = function(t, e) {
              ...
              return "style" === e || !et && -1 !== t.indexOf("<a") ? -1 === t.indexOf("currentColor") ? "bg" : "mask" : "svg"
            }(t.data.body, n),
            r = this._state.inline;
          Ct(this._shadowRoot, this._state = {
            rendered: !0,
            icon: t,
            inline: r,
            customisations: e,

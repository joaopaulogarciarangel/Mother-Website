var Iconify = function(e) {
  ...
  var n = Object.freeze({
    ...
    i = Object.freeze(Object.assign({}, r, {
      body: "",
      hidden: !1
    }));
  ...
  function o(e, n) {
    ...
    for (var o in i) o in t ? o in e && !(o in r) && (r[o] = t[o]) : o in n ? r[o] = n[o] : o in e && (r[o] = e[o]);
    return r
  }
  ...
  function c(e, n) {
    ...
    var r = function(e, n) {
      ...
      return (n || Object.keys(t).concat(Object.keys(r))).forEach((function e(n) {
        if (t[n]) return i[n] = [];
        if (!(n in i)) {
          i[n] = null;
  ...
  var u = /^[a-z0-9]+(-[a-z0-9]+)*$/,
    ...
    s = function(e, n) {
      return !!e && !("" !== e.provider && !e.provider.match(u) || !(n && "" === e.prefix || e.prefix.match(u)) || !e.name.match(u))
    },
    d = Object.assign({}, {
      provider: "",
      aliases: {},
  ...
  function v(e) {
    ...
    var n = e;
    if ("string" != typeof n.prefix || !e.icons || "object" != typeof e.icons) return null;
    ...
    for (var c in a) {
      var f = a[c],
        s = f.parent;
      if (!c.match(u) || "string" != typeof s || !t[s] && !a[s] || !l(f, i)) return null
    }
    return n
  }
  ...
  function b(e, n) {
    var t = [];
    return ("string" == typeof e ? [e] : Object.keys(p)).forEach((function(e) {
      ("string" == typeof e && "string" == typeof n ? [n] : Object.keys(p[e] || {})).forEach((function(n) {
        var r = h(e, n);
        t = t.concat(Object.keys(r.icons).map((function(t) {
          return ("" !== e ? "@" + e + ":" : "") + n + ":" + t
        })))
      }))
    })), t
  ...
  function x(e, n) {
    ...
    return !!t && function(e, n, t) {
      try {
        if ("string" == typeof t.body) return e.icons[n] = Object.assign({}, t), !0
      } catch (e) {}
      return !1
  ...
  function j(e, n) {
    ...
    if ("string" != typeof n && (n = e.provider || ""), m && !n && !e.prefix) {
      var t = !1;
      return v(e) && (e.prefix = "", c(e, (function(e, n) {
        n && x(e, n) && (t = !0)
      }))), t
    }
    var r = e.prefix;
  ...
  function M(e, n) {
    ...
    [t, i].forEach((function(e) {
      var n, t = [],
        ...
        i = e.vFlip,
        c = e.rotate;
      switch (r ? i ? c += 2 : (t.push("translate(" + (o.width + o.left).toString() + " " + (0 - o.top).toString() + ")"), t.push("scale(-1 1)"), o.top = o.left = 0) : i && (t.push("translate(" + (0 - o.left).toString() + " " + (o.height + o.top).toString() + ")"), t.push("scale(1 -1)"), o.top = o.left = 0), c < 0 && (c -= 4 * Math.floor(c / 4)), c %= 4) {
        case 1:
          n = o.height / 2 + o.top, t.unshift("rotate(90 " + n.toString() + " " + n.toString() + ")");
          break;
        case 2:
          t.unshift("rotate(180 " + (o.width / 2 + o.left).toString() + " " + (o.height / 2 + o.top).toString() + ")");
          break;
        case 3:
          n = o.width / 2 + o.left, t.unshift("rotate(-90 " + n.toString() + " " + n.toString() + ")")
      }
      c % 2 == 1 && (o.left !== o.top && (n = o.left, o.left = o.top, o.top = n), o.width !== o.height && (n = o.width, o.width = o.height, o.height = n)), t.length && (a = '<g transform="' + t.join(" ") + '">' + a + "</g>")
    }));
    var c, u, f = i.width,
      s = i.height,
      d = o.width,
      l = o.height;
    null === f ? c = C(u = null === s ? "1em" : "auto" === s ? l : s, d / l) : (c = "auto" === f ? d : f, u = null === s ? C(c, l / d) : "auto" === s ? l : s);
    var v = {},
      p = function(e, n) {
        (function(e) {
    ...
    return p("width", c), p("height", u), v.viewBox = o.left.toString() + " " + o.top.toString() + " " + d.toString() + " " + l.toString(), {
      attributes: v,
      body: a
    }
  }
  ...
  function L(e, n) {
    ...
    return r.forEach((function(t) {
      var r = "function" == typeof n ? n(t) : n + (F++).toString(),
        o = t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
      e = e.replace(new RegExp('([#;"])(' + o + ')([")]|\\.[a-z])', "g"), "$1" + r + i + "$3")
  ...
  function K(e, n) {
    ...
    if (t) {
      ...
      if (r !== _) {
        if (r)
          for (var i = G(t), o = 0; o < i; o++) H(t, D + o.toString());
        return V(t, $, _), void Q(t, 0)
      }
      for (var a = Math.floor(Date.now() / q) - 168, c = function(e) {
          var r = D + e.toString(),
            i = U(t, r);
          if ("string" == typeof i) {
            try {
              var o = JSON.parse(i);
              if ("object" == typeof o && "number" == typeof o.cached && o.cached > a && "string" == typeof o.provider && "object" == typeof o.data && "string" == typeof o.data.prefix && n(o, e)) return !0
            } catch (e) {}
            H(t, r)
          }
        }, u = G(t), f = u - 1; f >= 0; f--) c(f) || (f === u - 1 ? (u--, Q(t, u)) : N[e].add(f))
    }
  }

  function W() {
    if (!z)
      for (var e in z = !0, P) K(e, (function(e) {
        var n = e.data,
  ...
  function fe(e, n) {
    e.forEach((function(e) {
      ...
      t && (e.loaderCallbacks = t.filter((function(e) {
        return e.id !== n
      })))
    }))
  }
  ...
  function le(e, n, t, r) {
    ...
    function b() {
      "pending" === d && (d = "aborted"), g(), p.forEach((function(e) {
    ...
    function j() {
      if ("pending" === d) {
        g();
        var r = i.shift();
        if (void 0 === r) return p.length ? void(v = setTimeout((function() {
          g(), "pending" === d && (x(), y())
        }), e.timeout)) : void y();
        var o = {
          status: "pending",
          ...
          callback: function(n, t) {
            ! function(n, t, r) {
              ...
              if (o) return f = r, void(p.length || (i.length ? j() : y()));
              if (g(), x(), !e.random) {
                var a = e.resources.indexOf(n.resource); - 1 !== a && a !== e.index && (e.index = a)
              }
              d = "completed", h.forEach((function(e) {
                e(r)
              }))
            }(o, n, t)
          }
    ...
    return "function" == typeof r && h.push(r), setTimeout(j),
      function() {
        return {
          startTime: s,
          payload: n,
  ...
  function be(e, n) {
    ...
    z || W(), n.lastModified && ! function(e, n) {
      var t = e.lastModifiedCached;
      if (t && t >= n) return t === n;
      if (e.lastModifiedCached = n, t)
        for (var r in P) K(r, (function(t) {
          var r = t.data;
          return t.provider !== e.provider || r.prefix !== e.prefix || r.lastModified === n
        }));
      return !0
    }(e, n.lastModified) || Object.keys(n.icons).length && (n.not_found && delete(n = Object.assign({}, n)).not_found, t("local") || t("session"))
  }

  function me() {}

  function ye(e) {
    e.iconsLoaderFlag || (e.iconsLoaderFlag = !0, setTimeout((function() {
      e.iconsLoaderFlag = !1,
        function(e) {
          e.pendingCallbacksFlag || (e.pendingCallbacksFlag = !0, setTimeout((function() {
            ...
            if (n.length) {
              ...
              n.forEach((function(n) {
                ...
                o.pending = o.pending.filter((function(n) {
                  ...
                  return !1
                })), o.pending.length !== a && (t || fe([e], n.id), n.callback(o.loaded.slice(0), o.missing.slice(0), o.pending.slice(0), n.abort))
              }))
            }
          })))
        }(e)
  ...
  var xe = function(e, n) {
        ...
        i = function(e) {
          ...
          return e.forEach((function(e) {
            if (r.name !== e.name || r.prefix !== e.prefix || r.provider !== e.provider) {
              ...
              (a in u.icons ? n.loaded : "" === o || u.missing.has(a) ? n.missing : n.pending).push(f)
            }
          })), n
        }(r);
      if (!i.pending.length) {
      ...
      return i.pending.forEach((function(e) {
        ...
        var n = e.provider,
          t = e.prefix;
        u[n][t].length && function(e, n) {
          e.iconsToLoad ? e.iconsToLoad = e.iconsToLoad.concat(n).sort() : e.iconsToLoad = n, e.iconsQueueFlag || (e.iconsQueueFlag = !0, setTimeout((function() {
            e.iconsQueueFlag = !1;
            var n, t = e.provider,
              r = e.prefix,
              i = e.iconsToLoad;
            delete e.iconsToLoad, i && (n = ee(t)) && n.prepare(t, r, i).forEach((function(n) {
              ge(t, n, (function(t) {
                if ("object" != typeof t) n.icons.forEach((function(n) {
                  e.missing.add(n)
                }));
                else try {
                  var r = g(e, t);
  ...
  function we(e, n) {
    ...
    for (var r in n) {
      var i = n[r],
        o = typeof i;
      r in S ? (null === i || i && ("string" === o || "number" === o)) && (t[r] = i) : o === typeof t[r] && (t[r] = "rotate" === r ? i % 4 : i)
    }
    return t
  }
  var Oe = Object.assign({}, E, {
      inline: !1
    }),
    Se = "iconify-inline",
    ...
    if (e.observer) {
      ...
      if (!t.pendingScan)
        for (var r = 0; r < n.length; r++) {
          var i = n[r];
          if (i.addedNodes && i.addedNodes.length > 0 || "attributes" === i.type && void 0 !== i.target[Ee]) return void(t.paused || Fe(e))
        }
    }
  }
  ...
  function Ne(e) {
    ...
    if (!n || !n.instance) {
      ...
      t && window && (n || (n = {
        paused: 0
      }, e.observer = n), n.instance = new window.MutationObserver(Le.bind(null, e)), Pe(e, t), n.paused || Fe(e))
    }
  }
  ...
  function De(e) {
    var n = null !== Te;
    Te !== e && (Te = e, n && Me().forEach(_e)), n ? ze() : function(e) {
      var n = document;
      n.readyState && "loading" !== n.readyState ? e() : n.addEventListener("DOMContentLoaded", e)
    }(ze)
  }
  ...
  function He(e) {
    ...
    n && (_e(n), function(e) {
      Ie = Ie.filter((function(n) {
        return e !== n && e !== ("function" == typeof n.node ? n.node() : n.node)
      }))
    }(e))
  }
  var Qe = /[\s,]+/;
  ...
  function Be(e) {
    ...
    "string" == typeof i && (r.rotate = function(e, n) {
      void 0 === n && (n = 0);
      var t = e.replace(/^-?[0-9.]*/, "");
    ...
    }(r, o), Je.forEach((function(n) {
      var t = "data-" + n,
        i = function(e, n) {
          return e === n || "true" === e || "" !== e && "false" !== e && null
        }(e.getAttribute(t), t);
  ...
  function Ke(e, n) {
    var t = -1 === e.indexOf("xlink:") ? "" : ' xmlns:xlink="http://www.w3.org/1999/xlink"';
  ...
  function We(e) {
    ...
    return ["provider", "prefix"].forEach((function(t) {
  ...
  function Ye(e, n, t) {
    ...
    var i = [];
    for (var o in n) r.getPropertyValue(o) || (i.push(o), r.setProperty(o, n[o]));
    return i
  }
  ...
  function ln(e, n) {
    ...
    function i(e, n) {
      ...
      if (t && t.querySelectorAll) {
        ...
        (function(e) {
          var n = [];
          return e.querySelectorAll("svg.iconify, i.iconify, span.iconify, i.iconify-inline, span.iconify-inline").forEach((function(e) {
            var t = e[Ee] || "svg" !== e.tagName.toLowerCase() ? Be(e) : null;
            t && n.push({
              node: e,
              props: t
            })
          ...
          if (!a) {
            var u = i(r.icon, !0),
              f = u.status,
              s = u.icon;
            return s ? void c(t, r, s) : (o = o || "loading" === f, void(t[Ee] = Object.assign({}, r, {
              status: f
            })))
          }
          if (function(e, n) {
            ...
            if (!(n = i(r.icon, a.name !== r.name)).icon) return o = o || "loading" === n.status, void Object.assign(a, Object.assign({}, r, {
              status: n.status
            }))
          } else {
          ...
          c(t, r, n.icon)
        })), e.temporary && !o ? He(t) : n && o ? Ve(t, !0) : a && e.observer && qe(e)
      }

      function c(n, t, i) {
        if (a || (a = !0, Re(e)), "SVG" !== n.tagName.toUpperCase()) {
          var o = t.mode,
            c = "mask" === o || "bg" !== o && ("style" === o ? -1 !== i.body.indexOf("currentColor") : null);
          if ("boolean" == typeof c) return void
          function(e, n, t, r) {
            var i = n.customisations,
              o = M(t, i),
              a = o.attributes,
              c = e[Ee],
              u = Ke(o.body, Object.assign({}, a, {
                width: t.width + "",
                height: t.height + ""
              })),
              f = Xe(e, We(n.icon), new Set(c && c.addedClasses)),
              s = 'url("data:image/svg+xml,' + (l = u, l.replace(/"/g, "'").replace(/%/g, "%25").replace(/#/g, "%23").replace(/</g, "%3C").replace(/>/g, "%3E").replace(/\s+/g, " ") + '")'),
              d = Object.assign({}, {
                "--svg": s,
                width: fn(a.width),
                height: fn(a.height)
    ...
    var o = function(e) {
      var n = t[e],
        r = function(t) {
          var r = n[t];
          xe(Array.from(r).map((function(n) {
            return {
              provider: e,
              prefix: t,
              name: n
  ...
  function vn(e, n, t) {
    ...
    var i = f(e),
      o = we(Oe, n || {}),
      a = Ze(document.createElement("span"), {
        name: e,
        icon: i,
        customisations: o
      }, r);
  ...
  if ("undefined" != typeof document && "undefined" != typeof window) {
    ...
    if (void 0 !== yn.IconifyPreload) {
      ...
      "object" == typeof xn && null !== xn && (xn instanceof Array ? xn : [xn]).forEach((function(e) {
        try {
          ("object" != typeof e || null === e || e instanceof Array || "object" != typeof e.icons || "string" != typeof e.prefix || !j(e)) && console.error(jn)
        } catch (e) {
          console.error(jn)
        }
      }))
  ...
  if (Z("", ue), "undefined" != typeof document && "undefined" != typeof window) {
    W();
    var Sn = window;
    if (void 0 !== Sn.IconifyProviders) {
      ...
      if ("object" == typeof En && null !== En)
        for (var In in En) {
          ...
          try {
            var Cn = En[In];
            if ("object" != typeof Cn || !Cn || void 0 === Cn.resources) continue;
  ...
  return e._api = Mn, e.addAPIProvider = oe, e.addCollection = j, e.addIcon = x, e.buildIcon = M, e.calculateSize = C, e.default = Tn, e.disableCache = On, e.enableCache = wn, e.getIcon = O, e.getVersion = pn, e.iconExists = w, e.listIcons = b, e.loadIcon = je, e.loadIcons = xe, e.observe = Ve, e.pauseObserver = $e, e.renderHTML = gn, e.renderIcon = bn, e.renderSVG = hn, e.replaceIDs = L, e.resumeObserver = Ue, e.scan = mn, e.stopObserving = He, Object.defineProperty(e, "__esModule", {
    value: !0
  }), e
}({});

! function(t, e) {
  ...
  function H(t) {
    q.debug = t.debug || q.debug, q.error = t.error || q.error, q.info = t.info || q.info, q.log = t.log || q.log, q.verbose = t.verbose || q.verbose, q.warning = t.warning || q.warning
  }
  ...
  function G(t) {
    ...
    return s.min < n.min || s.min > n.max || s.max < n.min || s.max > n.max || (i.max >= o.min && i.max <= (o.max + o.min) / 2 && a > 0 || i.min <= o.max && i.min > (o.max + o.min) / 2 && a < 0) && (e.velocity = a * -r, e.bounced = !0), e
  }
  ...
  function N(t) {
    if (!X() && "undefined" != typeof MutationObserver) return new MutationObserver(t)
  }
  ...
  function lt(t) {
    return {
      ...
      mass: t.getMass(),
      velocity: t.velocity,
      factor: g.create(O(t.options.bounce.horizontal), O(t.options.bounce.vertical))
    }
  }
  ...
  function ct(t, e) {
    ...
    const l = -Math.atan2(r, a),
      ...
      m = p.rotate(-l),
      g = f.rotate(-l);
    t.velocity.x = m.x * t.factor.x, t.velocity.y = m.y * t.factor.y, e.velocity.x = g.x * e.factor.x, e.velocity.y = g.y * e.factor.y
  }
    ...
    if (s.enable) {
      ...
      switch (s.startValue) {
        ...
        case "max":
          ...
          break;
        default:
          o.value = P(o), t && (o.status = _() >= .5 ? "increasing" : "decreasing")
      }
    }
  ...
  function At(t) {
    ...
    if (i.s) {
      const t = i.l < .5 ? i.l * (1 + i.s) : i.l + i.s - i.l * i.s,
        s = 2 * i.l - t;
      e.r = kt(s, t, i.h + 1 / 3), e.g = kt(s, t, i.h), e.b = kt(s, t, i.h - 1 / 3)
  ...
  function qt(t, e, i, s) {
    let o = t,
      n = e;
    return void 0 === o.r && (o = At(t)), void 0 === n.r && (n = At(e)), {
      b: M(o.b, n.b, i, s),
      g: M(o.g, n.g, i, s),
      r: M(o.r, n.r, i, s)
    }
  ...
  function Yt(t, e, i) {
    t.enable = e.enable, t.enable ? (t.velocity = C(e.speed) / 100 * i, t.decay = 1 - C(e.decay), t.status = "increasing", t.loops = 0, t.maxLoops = C(e.count), t.time = 0, t.delayTime = 1e3 * C(e.delay), e.sync || (t.velocity *= _(), t.value *= _()), t.initialValue = t.value) : t.velocity = 0
  }
  ...
  function Kt(t) {
    const {
      ...
      shadow: h,
      transform: d
    } = t, u = s.getPosition(), p = s.rotation + (s.pathRotation ? s.velocity.angle : 0), f = Math.sin(p), m = Math.cos(p), g = {
      a: m * (d.a ?? 1),
      b: f * (d.b ?? 1),
      c: -f * (d.c ?? 1),
      d: m * (d.d ?? 1)
    };
    i.setTransform(g.a, g.b, g.c, g.d, u.x, u.y), i.beginPath(), a && (i.globalCompositeOperation = r);
    const v = s.shadowColor;
    h.enable && v && (i.shadowBlur = h.blur, i.shadowColor = Ut(v), i.shadowOffsetX = h.offset.x, i.shadowOffsetY = h.offset.y), n.fill && (i.fillStyle = n.fill);
    const y = s.strokeWidth ?? 0;
    i.lineWidth = y, n.stroke && (i.strokeStyle = n.stroke), te(e, i, s, l, c, o), y > 0 && i.stroke(), s.close && i.closePath(), s.fill && i.fill(), ee(e, i, s, l, c, o), i.globalCompositeOperation = "source-over", i.setTransform(1, 0, 0, 1, 0, 0)
  }
  ...
  class ae {
    constructor(t) {
      this.container = t, this._applyPostDrawUpdaters = t => {
        ...
        for (const s of this._colorPlugins)
          if (!e && s.particleFillColor && (e = Et(s.particleFillColor(t))), !i && s.particleStrokeColor && (i = Et(s.particleStrokeColor(t))), e && i) break;
        return [e, i]
      }, this._initCover = () => {
    ...
    clear() {
      const t = this.container.actualOptions,
        e = t.particles.move.trail,
        i = this._trailFill;
      t.backgroundMask.enable ? this.paint() : e.enable && e.length > 0 && i ? i.color ? this._paintBase(Ut(i.color, i.opacity)) : i.image && this._paintImage(i.image, i.opacity) : this.draw((t => {
        Jt(t, this.size)
      }))
    }
    destroy() {
    ...
    drawParticle(t, e) {
      ...
      n || (n = s), a || (a = o), (n || a) && this.draw((s => {
        ...
        f.stroke = a ? $t(a, u) : f.fill, this._applyPreDrawUpdaters(s, t, i, d, f, p), Kt({
          container: o,
          context: s,
          particle: t,
          delta: e,
    ...
    async init() {
      this._safeMutationObserver((t => t.disconnect())), this._mutationObserver = N((t => {
    ...
    paint() {
      const t = this.container.actualOptions;
      this.draw((e => {
        t.backgroundMask.enable && t.backgroundMask.cover ? (Jt(e, this.size), this._paintBase(this._coverColorStyle)) : this._paintBase()
      }))
    }
    resize() {
      ...
      return this.element.width = i.width = this.element.offsetWidth * e, this.element.height = i.height = this.element.offsetHeight * e, this.container.started && (this.resizeFactor = {
        width: i.width / n.width,
        height: i.height / n.height
      }), !0
    }
    stop() {
      this._safeMutationObserver((t => t.disconnect())), this._mutationObserver = void 0, this.draw((t => Jt(t, this.size)))
    }
    async windowResize() {
  ...
  function re(t, e, i, s, o) {
    if (s) {
      ...
      yt(o) ? s.capture = o : void 0 !== o && (s = o), t.addEventListener(e, i, s)
    } else {
      const s = o;
  ...
  class le {
    constructor(t) {
      this.container = t, this._doMouseTouchClick = t => {
        ...
        const p = u,
          f = n.canvas.element;
        f && (f.style.pointerEvents = p === f ? "initial" : "none"), (a.interactivity.events.onHover.enable || a.interactivity.events.onClick.enable) && (re(u, r, i.mouseMove, e), re(u, l, i.touchStart, e), re(u, h, i.touchMove, e), a.interactivity.events.onClick.enable ? (re(u, c, i.touchEndClick, e), re(u, o, i.mouseUp, e), re(u, s, i.mouseDown, e)) : re(u, c, i.touchEnd, e), re(u, t, i.mouseLeave, e), re(u, d, i.touchCancel, e))
        ...
        const e = this._handlers,
          ...
          o = i.canvas.element;
        let r = n;
        "window" === s ? (i.interactivity.element = window, r = a) : i.interactivity.element = "parent" === s && o ? o.parentElement ?? o.parentNode : o, this._manageMediaMatch(t), this._manageResize(t), this._manageInteractivityListeners(r, t), document && re(document, p, e.visibilityChange, t, !1)
      }, this._manageMediaMatch = t => {
        const e = this._handlers,
          i = j("(prefers-color-scheme: dark)");
        i && (void 0 === i.addEventListener ? void 0 !== i.addListener && (t ? i.addListener(e.oldThemeChange) : i.removeListener(e.oldThemeChange)) : re(i, "change", e.themeChange, t))
      }, this._manageResize = t => {
        const e = this._handlers,
          i = this.container;
        if (!i.actualOptions.interactivity.events.resize) return;
        if ("undefined" == typeof ResizeObserver) return void re(window, u, e.resize, t);
  ...
  class ue {
    constructor() {
      this.composite = "destination-out", this.cover = new de, this.enable = !1
    }
    load(t) {
      if (t) {
  ...
  class me {
    ...
    load(t) {
      ...
      void 0 !== e && (this.ids = e), void 0 !== t.selectors && (this.selectors = t.selectors), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.mode && (this.mode = t.mode), void 0 !== t.type && (this.type = t.type)
    }
  }
  class ge {
    constructor() {
  ...
  class we {
    constructor() {
      this.onClick = new fe, this.onDiv = new me, this.onHover = new ve, this.resize = new ye
    }
    get onclick() {
      return this.onClick
    }
    ...
    load(t) {
      ...
      void 0 !== e && (this.onDiv = dt(e, (t => {
        const e = new me;
        return e.load(t), e
      }))), this.onHover.load(t.onHover ?? t.onhover), yt(t.resize) ? this.resize.enable = t.resize : this.resize.load(t.resize)
    }
  }
  class be {
    constructor(t, e) {
  ...
  class xe {
    constructor(t, e) {
      this.detectsOn = "window", this.events = new we, this.modes = new be(t, e)
    }
    get detect_on() {
  ...
  class Ce {
    ...
    load(t) {
      t && (void 0 !== t.count && (this.count = T(t.count)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.offset && (this.offset = T(t.offset)), void 0 !== t.speed && (this.speed = T(t.speed)), void 0 !== t.decay && (this.decay = T(t.decay)), void 0 !== t.delay && (this.delay = T(t.delay)), void 0 !== t.sync && (this.sync = t.sync))
    }
  }
  class Se {
    constructor() {
  ...
  class Ie {
    ...
    load(t) {
      t && (void 0 !== t.count && (this.count = T(t.count)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed && (this.speed = T(t.speed)), void 0 !== t.decay && (this.decay = T(t.decay)), void 0 !== t.delay && (this.delay = T(t.delay)), void 0 !== t.sync && (this.sync = t.sync))
    }
  }
  class De extends Ie {
    constructor() {
    ...
    load(t) {
      super.load(t), t && (void 0 !== t.minimumValue && (this.minimumValue = t.minimumValue), void 0 !== t.mode && (this.mode = t.mode), void 0 !== t.startValue && (this.startValue = t.startValue))
    }
  }
  class Ee {
    constructor() {
  ...
  class Re {
    ...
    load(t) {
      t && (yt(t.random) ? this.random.enable = t.random : this.random.load(t.random), void 0 !== t.value && (this.value = T(t.value, this.random.enable ? this.random.minimumValue : void 0)))
    }
  }
  class Le extends Re {
    constructor() {
  ...
  class Fe extends Le {
    ...
    load(t) {
      if (super.load(t), !t) return;
      void 0 !== (t.animation ?? t.anim) && (this.value = T(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
    }
  }
  class Ae extends Re {
    constructor() {
  ...
  class Ve {
    constructor() {
      this.absorb = new Te, this.bounce = new Be, this.enable = !1, this.maxSpeed = 50, this.mode = "bounce", this.overlap = new Oe
    }
    load(t) {
      t && (this.absorb.load(t.absorb), this.bounce.load(t.bounce), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.maxSpeed && (this.maxSpeed = T(t.maxSpeed)), void 0 !== t.mode && (this.mode = t.mode), this.overlap.load(t.overlap))
    }
  }
  class Ue {
    constructor() {
    ...
    load(t) {
      t && (void 0 !== t.offset && (this.offset = T(t.offset)), void 0 !== t.value && (this.value = T(t.value)))
    }
  }
  class $e {
    constructor() {
    ...
    load(t) {
      if (!t) return;
      void 0 !== t.distance && (this.distance = T(t.distance)), void 0 !== t.enable && (this.enable = t.enable);
  ...
  class He {
    ...
    load(t) {
      t && (void 0 !== t.acceleration && (this.acceleration = T(t.acceleration)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.inverse && (this.inverse = t.inverse), void 0 !== t.maxSpeed && (this.maxSpeed = T(t.maxSpeed)))
    }
  }
  class We {
    constructor() {
  ...
  class Ne {
    ...
    load(t) {
      ...
      this.angle.load(bt(t.angle) ? {
        value: t.angle
      } : t.angle), this.attract.load(t.attract), this.center.load(t.center), void 0 !== t.decay && (this.decay = T(t.decay)), void 0 !== t.direction && (this.direction = t.direction), void 0 !== t.distance && (this.distance = bt(t.distance) ? {
        horizontal: t.distance,
        vertical: t.distance
      } : {
        ...t.distance
      }), void 0 !== t.drift && (this.drift = T(t.drift)), void 0 !== t.enable && (this.enable = t.enable), this.gravity.load(t.gravity);
      const e = t.outModes ?? t.outMode ?? t.out_mode;
      void 0 !== e && (_t(e) ? this.outModes.load(e) : this.outModes.load({
        default: e
      })), this.path.load(t.path ?? t.noise), void 0 !== t.random && (this.random = t.random), void 0 !== t.size && (this.size = t.size), void 0 !== t.speed && (this.speed = T(t.speed)), this.spin.load(t.spin), void 0 !== t.straight && (this.straight = t.straight), this.trail.load(t.trail), void 0 !== t.vibrate && (this.vibrate = t.vibrate), void 0 !== t.warp && (this.warp = t.warp)
    }
  }
  class Ze extends De {
    constructor() {
    ...
    load(t) {
      void 0 !== t?.opacity_min && void 0 === t.minimumValue && (t.minimumValue = t.opacity_min), super.load(t), t && void 0 !== t.destroy && (this.destroy = t.destroy)
    }
  }
  class Qe extends Re {
    constructor() {
      super(), this.animation = new Ze, this.random.minimumValue = .1, this.value = 1
    }
    get anim() {
      return this.animation
    }
    ...
    load(t) {
      ...
      super.load(t);
      const e = t.animation ?? t.anim;
      void 0 !== e && (this.animation.load(e), this.value = T(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
    }
  }
  class Je {
    constructor() {
  ...
  class ri {
    constructor() {
      this.loadShape = (t, e, i, s) => {
        ...
        a && (this.options[e] = n), r && s && (this.options[i] = n), this.options[e] = st(this.options[e] ?? n, t), this.options[i] && !s || (this.options[i] = st(this.options[i] ?? n, t))
    ...
    load(t) {
      ...
      this.loadShape(t.character, ei, ii, !0), this.loadShape(t.polygon, ni, ai, !1), this.loadShape(t.image ?? t.images, si, oi, !0), void 0 !== t.close && (this.close = t.close), void 0 !== t.fill && (this.fill = t.fill), void 0 !== t.type && (this.type = t.type)
    }
  }
  class li extends De {
    constructor() {
    ...
    load(t) {
      void 0 !== t?.size_min && void 0 === t.minimumValue && (t.minimumValue = t.size_min), super.load(t), t && void 0 !== t.destroy && (this.destroy = t.destroy)
    }
  }
  class ci extends Re {
    constructor() {
  ...
  class hi {
    ...
    load(t) {
      t && (void 0 !== t.color && (this.color = ke.create(this.color, t.color)), void 0 !== t.width && (this.width = T(t.width)), void 0 !== t.opacity && (this.opacity = T(t.opacity)))
    }
  }
  class di extends Re {
    constructor() {
  ...
  class ui {
    constructor(t, e) {
      this._engine = t, this._container = e, this.bounce = new Be, this.collisions = new Ve, this.color = new ke, this.color.value = "#fff", this.groups = {}, this.move = new Ne, this.number = new Ke, this.opacity = new Qe, this.reduceDuplicates = !1, this.shadow = new ti, this.shape = new ri, this.size = new ci, this.stroke = new hi, this.zIndex = new di
    }
    load(t) {
      if (!t) return;
      if (this.bounce.load(t.bounce), this.color.load(ke.create(this.color, t.color)), void 0 !== t.groups)
      ...
      void 0 !== e && (this.collisions.enable = e), this.collisions.load(t.collisions), void 0 !== t.interactivity && (this.interactivity = st({}, t.interactivity));
      const i = t.stroke ?? t.shape?.stroke;
      if (i && (this.stroke = dt(i, (t => {
          const e = new hi;
          return e.load(t), e
        }))), this._container) {
  ...
  class mi {
    ...
    load(t) {
      if (!t) return;
      void 0 !== t.preset && dt(t.preset, (t => this._importPreset(t))), void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay), void 0 !== t.delay && (this.delay = T(t.delay));
      const e = t.detectRetina ?? t.retina_detect;
      void 0 !== e && (this.detectRetina = e), void 0 !== t.duration && (this.duration = T(t.duration));
      ...
      yt(s) ? this.fullScreen.enable = s : this.fullScreen.load(s), this.backgroundMask.load(t.backgroundMask), this.interactivity.load(t.interactivity), t.manualParticles && (this.manualParticles = t.manualParticles.map((t => {
        const e = new _e;
        return e.load(t), e
      }))), this.particles.load(t.particles), this.style = st(this.style, t.style), this._engine.plugins.loadOptions(this, t), void 0 !== t.smooth && (this.smooth = t.smooth);
  ...
  class gi {
    constructor(t, e) {
      this.container = e, this._engine = t, this._interactors = t.plugins.getInteractors(this.container, !0), this._externalInteractors = [], this._particleInteractors = []
    }
  ...
  class yi {
    constructor(t, e, i, s, o, n) {
      this.container = i, this._calcPosition = (t, e, i, s = 0) => {
        ...
        return l(r.left ?? r.default), l(r.right ?? r.default), c(r.top ?? r.default), c(r.bottom ?? r.default), this._checkOverlap(n, s) ? this._calcPosition(t, void 0, i, s + 1) : n
        ...
        return e.straight || (t.angle += P(T(o.left, o.right))), e.random && "number" == typeof e.speed && (t.length *= _()), t
        ...
        return !!this.container.particles.find((e => D(t, e.position) < s + e.getRadius()))
        ...
        return Math.floor(((this.roll.angle ?? 0) + i) / (Math.PI / e)) % 2 ? this.backColor ? this.backColor : this.roll.alter ? oe(t, this.roll.alter.type, this.roll.alter.value) : t : t
        ...
        switch (this.moveCenter = {
          ...
          }, this.direction = E(this.options.move.direction, this.position, this.moveCenter), this.options.move.direction) {
          case "inside":
            this.outType = "inside";
            break;
          case "outside":
    ...
    init(t, e, i, s) {
      ...
      const p = new xe(n, o);
      p.load(o.actualOptions.interactivity), p.load(l.interactivity), this.interactivity = p, this.fill = u?.fill ?? l.shape.fill, this.close = u?.close ?? l.shape.close, this.options = l;
      const f = this.options.move.path;
      this.pathDelay = 1e3 * O(f.delay), f.generator && (this.pathGenerator = this._engine.plugins.getPathGenerator(f.generator), this.pathGenerator && o.addPath(f.generator, this.pathGenerator) && this.pathGenerator.init(o)), o.retina.initParticle(this), this.size = ft(this.options.size, a), this.bubble = {
        inRange: !1
      }, this.slow = {
        inRange: !1,
        factor: 1
      }, this._initPosition(e), this.initialVelocity = this._calculateVelocity(), this.velocity = this.initialVelocity.copy(), this.moveDecay = 1 - C(this.options.move.decay);
      const m = o.particles;
      m.needsSort = m.needsSort || m.lastZIndex < this.position.z, m.lastZIndex = this.position.z, this.zIndexFactor = this.position.z / o.zLayers, this.sides = 24;
      let g = o.drawers.get(this.shape);
      g || (g = this._engine.plugins.getShapeDrawer(this.shape), g && o.drawers.set(this.shape, g)), g && g.loadShape && g.loadShape(this);
      const v = g?.getSidesCount;
      v && (this.sides = v(this)), this.spawning = !1, this.shadowColor = Ot(this.options.shadow.color);
  ...
  class zi {
    constructor(t, e) {
      this.rectangle = t, this.capacity = e, this._subdivide = () => {
        ...
        for (let n = 0; n < 4; n++) this._subs.push(new zi(new xi(t + i / 2 * (n % 2), e + s / 2 * (Math.round(n / 2) - n % 2), i / 2, s / 2), o));
        this._divided = !0
    ...
    query(t, e, i) {
      ...
      for (const i of this._points) !t.contains(i.position) && D(t.position, i.position) > i.particle.getRadius() && (!e || e(i.particle)) || s.push(i.particle);
      if (this._divided)
  ...
  const Mi = t => new xi(-t.width / 4, -t.height / 4, 3 * t.width / 2, 3 * t.height / 2);
  class Pi {
    constructor(t, e) {
      this._applyDensity = (t, e, i) => {
        ...
        this.limit = s.limit * o, l < r ? this.push(Math.abs(r - l), void 0, t, i) : l > r && this.removeQuantity(l - r, i)
        ...
        try {
          let o = this.pool.pop();
          o ? o.init(this._nextId, t, e, i) : o = new yi(this._engine, this._nextId, this._container, t, e, i);
          let n = !0;
          if (s && (n = s(o)), !n) return;
        ...
        return this._array.splice(t, 1), this._zArray.splice(o, 1), this.pool.push(s), this._engine.dispatchEvent("particleRemoved", {
          container: this._container,
          data: {
            particle: s
          }
        }), !0
      }, this._engine = t, this._container = e, this._nextId = 0, this._array = [], this._zArray = [], this.pool = [], this.limit = 0, this.needsSort = !1, this.lastZIndex = 0, this._interactionManager = new gi(t, e);
      const i = e.canvas.size;
      this.quadTree = new zi(Mi(i), 4), this.movers = this._engine.plugins.getMovers(e, !0), this.updaters = this._engine.plugins.getUpdaters(e, !0)
    }
    get count() {
    ...
    addManualParticles() {
      const t = this._container,
        e = t.actualOptions;
      for (const i of e.manualParticles) this.addParticle(i.position ? gt(i.position, t.canvas.size) : void 0, i.options)
    }
    addParticle(t, e, i, s) {
    ...
    init() {
      ...
      if (this.addManualParticles(), !i) {
        for (const t in e.particles.groups) {
          ...
          for (let s = this.count, o = 0; o < i.number?.value && s < e.particles.number.value; s++, o++) this.addParticle(void 0, i, t)
        }
    ...
    async update(t) {
      ...
      for (const s of this._array) {
        ...
        s.destroyed ? i.add(s) : this.quadTree.insert(new wi(s.getPosition(), s))
      }
      if (i.size) {
        const t = t => !i.has(t);
        this._array = this.filter(t), this._zArray = this._zArray.filter(t), this.pool.push(...i)
      }
      ...
      if (delete e.canvas.resizeFactor, this.needsSort) {
        ...
        t.sort(((t, e) => e.position.z - t.position.z || t.id - e.id)), this.lastZIndex = t[t.length - 1].position.z, this.needsSort = !1
      }
    }
  }
  class Ci {
    ...
    init() {
      const t = this.container,
        e = t.actualOptions;
      this.pixelRatio = !e.detectRetina || X() ? 1 : window.devicePixelRatio, this.reduceFactor = 1;
      ...
      const s = e.particles,
        o = s.move;
      this.attractDistance = C(o.attract.distance) * i, this.maxSpeed = C(o.gravity.maxSpeed) * i, this.sizeAnimationSpeed = C(s.size.animation.speed) * i
    }
    initParticle(t) {
      const e = t.options,
        i = this.pixelRatio,
        ...
        o = s.distance,
        n = t.retina;
      n.attractDistance = C(s.attract.distance) * i, n.moveDrift = C(s.drift) * i, n.moveSpeed = C(s.speed) * i, n.sizeAnimationSpeed = C(e.size.animation.speed) * i;
      const a = n.maxDistance;
      a.horizontal = void 0 !== o.horizontal ? o.horizontal * i : void 0, a.vertical = void 0 !== o.vertical ? o.vertical * i : void 0, n.maxSpeed = C(s.gravity.maxSpeed) * i
    }
  }
  ...
  class Oi {
    constructor(t, e, i) {
      this.id = e, this._intersectionManager = t => {
        ...
        try {
          if (!this.smooth && void 0 !== this.lastFrameTime && t < this.lastFrameTime + 1e3 / this.fpsLimit) return void this.draw(!1);
          ...
          if (this.addLifeTime(e.value), this.lastFrameTime = t, e.value > 1e3) return void this.draw(!1);
      ...
      }, this._engine = t, this.fpsLimit = 120, this.smooth = !1, this._delay = 0, this._duration = 0, this._lifeTime = 0, this._firstStart = !0, this.started = !1, this.destroyed = !1, this._paused = !0, this.lastFrameTime = 0, this.zLayers = 100, this.pageHidden = !1, this._sourceOptions = i, this._initialSourceOptions = i, this.retina = new Ci(this), this.canvas = new ae(this), this.particles = new Pi(this._engine, this), this.pathGenerators = new Map, this.interactivity = {
        mouse: {
          clicking: !1,
          inside: !1
        }
    ...
    addPath(t, e, i = !1) {
      return !(!Si(this) || !i && this.pathGenerators.has(t)) && (this.pathGenerators.set(t, e ?? Ti), !0)
    }
    alive() {
    ...
    draw(t) {
      ...
      this._drawAnimationFrame = requestAnimationFrame((async t => {
        e && (this.lastFrameTime = void 0, e = !1), await this._nextFrame(t)
      }))
    }
    async export (t, e = {}) {
    ...
    async init() {
      ...
      this._options = ki(this._engine, this, this._initialSourceOptions, this.sourceOptions), this.actualOptions = ki(this._engine, this, this._options);
      const e = this._engine.plugins.getAvailablePlugins(this);
      for (const [t, i] of e) this.plugins.set(t, i);
      this.retina.init(), await this.canvas.init(), this.updateActualOptions(), this.canvas.initBackground(), this.canvas.resize(), this.zLayers = this.actualOptions.zLayers, this._duration = 1e3 * C(this.actualOptions.duration), this._delay = 1e3 * C(this.actualOptions.delay), this._lifeTime = 0, this.fpsLimit = this.actualOptions.fpsLimit > 0 ? this.actualOptions.fpsLimit : 120, this.smooth = this.actualOptions.smooth;
    ...
    pause() {
      if (Si(this) && (void 0 !== this._drawAnimationFrame && (cancelAnimationFrame(this._drawAnimationFrame), delete this._drawAnimationFrame), !this._paused)) {
    ...
    async reset() {
      if (Si(this)) return this._initialSourceOptions = void 0, this._options = ki(this._engine, this), this.actualOptions = ki(this._engine, this, this._options), this.refresh()
    }
    setNoise(t, e, i) {
    ...
    async start() {
      Si(this) && !this.started && (await this.init(), this.started = !0, await new Promise((t => {
  ...
  class Ri {
    constructor() {
      this._configs = new Map, this._domArray = [], this._eventDispatcher = new Ii, this._initialized = !1, this.plugins = new Ei(this)
    }
    get configs() {
      const t = {};
    ...
    addConfig(t, e) {
      wt(t) ? e && (e.name = t, this._configs.set(t, e)) : this._configs.set(t.name ?? "default", t)
    }
    addEventListener(t, e) {
    ...
    async addShape(t, e, i, s, o, n = !0) {
      let a, r, l, c, h = n;
      yt(i) ? (h = i, r = void 0) : r = i, yt(s) ? (h = s, l = void 0) : l = s, yt(o) ? (h = o, c = void 0) : c = o, a = xt(e) ? {
        afterEffect: l,
        destroy: c,
        draw: e,
        init: r
      } : e, this.plugins.addShapeDrawer(t, a), await this.refresh(h)
    }
    dispatchEvent(t, e) {
    ...
    async loadFromArray(t, e, i) {
      ...
      return ! function(t) {
        ...
        var e
      }(t) ? (s = {}, wt(t) ? s.id = t : s.options = t, bt(e) ? s.index = e : s.options = e ?? s.options, s.index = i ?? s.index) : s = t, this._loadParams(s)
    }
    async loadJSON(t, e, i) {
      let s, o;
      return bt(e) || void 0 === e ? s = t : (o = t, s = e), this._loadParams({
        id: o,
        url: s,
        index: i
      })
    ...
    async set(t, e, i, s) {
      ...
      return wt(t) ? o.id = t : o.element = t, e instanceof HTMLElement ? o.element = e : o.options = e, bt(i) ? o.index = i : o.options = i ?? o.options, this._loadParams(o)
    }
    async setJSON(t, e, i, s) {
      const o = {};
      return t instanceof HTMLElement ? (o.element = t, o.url = e, o.index = i) : (o.id = t, o.element = e, o.url = i, o.index = s), this._loadParams(o)
    }
    setOnClickHandler(t) {
      const e = this.dom();
    ...
    async _loadParams(t) {
      const e = t.id ?? `tsparticles${Math.floor(1e4*_())}`,
        ...
        n = o ? await async function(t) {
          ...
          return i.ok ? i.json() : (W().error(`${f} ${i.status} while retrieving config file`), t.fallback)
        }({
          fallback: t.options,
          url: o,
          index: s
      ...
      return c >= 0 ? l.splice(c, 0, d) : l.push(d), d.canvas.loadCanvas(h), await d.start(), d
    }
  }
  class Li {
    constructor() {
    ...
    handleRangeColor(t) {
      const e = t.value.hsl ?? t.value;
      if (void 0 !== e.h && void 0 !== e.l) return At({
        h: C(e.h),
        l: C(e.l),
        s: C(e.s)
      })
  ...
  class Ui {
    constructor() {
      this.angle = 90, this.count = 50, this.spread = 45, this.startVelocity = 45, this.decay = .9, this.gravity = 1, this.drift = 0, this.ticks = 200, this.position = {
        x: 50,
        y: 50
      }, this.colors = ["#26ccff", "#a25afd", "#ff5e7e", "#88ff5a", "#fcff42", "#ffa62d", "#ff36ff"], this.shapes = ["square", "circle"], this.scalar = 1, this.zIndex = 100, this.disableForReducedMotion = !0, this.shapeOptions = {}
    }
    get origin() {
      return {
    ...
    load(t) {
      ...
      void 0 !== e && (this.count = e), void 0 !== t.spread && (this.spread = t.spread), void 0 !== t.startVelocity && (this.startVelocity = t.startVelocity), void 0 !== t.decay && (this.decay = t.decay), void 0 !== t.gravity && (this.gravity = t.gravity), void 0 !== t.drift && (this.drift = t.drift), void 0 !== t.ticks && (this.ticks = t.ticks);
      const i = t.origin;
      ...
      s.spin.enable ? function(t, e) {
        ...
        function(t) {
          ...
          if (r || l)
            ...
            const i = t.position,
              s = t.velocity;
            r && (i.x < e.x && s.x < 0 || i.x > e.x && s.x > 0) && (s.x *= -_()), l && (i.y < e.y && s.y < 0 || i.y > e.y && s.y > 0) && (s.y *= -_())
          }
        }(t)
    }
  }
  ...
  class Gi {
    ...
    init(t) {
      ...
      e && (t.color = Xt(e, t.options.color.animation, this.container.retina.reduceFactor))
    }
    isEnabled(t) {
      const {
        h: e,
    ...
    update(t, e) {
      ! function(t, e) {
        ...
        a && Wi(e, a, i, 360, !1), r && Wi(e, r, s, 100, !0), l && Wi(e, l, o, 100, !0)
      }(t, e)
    }
  }
  class Xi {
    ...
    init(t) {
      ...
      t.opacity = ft(e, 1);
      const i = e.animation;
      i.enable && (t.opacity.velocity = C(i.speed) / 100 * this.container.retina.reduceFactor, i.sync || (t.opacity.velocity *= _()))
    }
    isEnabled(t) {
  ...
  class ji {
    ...
    update(t, e, i, s) {
      ...
      switch (t.outType) {
        case "normal":
        case "outside":
          if (tt(t.position, o.canvas.size, g.origin, t.getRadius(), e)) return;
          break;
        case "inside": {
          const {
            dx: e,
  ...
  class Ni {
    ...
    update(t, e, i, s) {
      ...
      if (o.enable) {
        ...
        tt(t.position, n.canvas.size, g.origin, r, e) || n.particles.remove(t)
      }
    }
  }
  class Zi {
      ...
      switch (t.outType) {
        case "inside": {
          const {
            x: e,
            y: i
          } = t.velocity, s = g.origin;
          s.length = t.moveCenter.radius, s.angle = t.velocity.angle + Math.PI, s.addTo(g.create(t.moveCenter));
          const {
            dx: n,
            dy: a
          } = I(t.position, s);
          if (e <= 0 && n >= 0 || i <= 0 && a >= 0 || e >= 0 && n <= 0 || i >= 0 && a <= 0) return;
          t.position.x = Math.floor(P({
            min: 0,
            max: o.canvas.size.width
          })), t.position.y = Math.floor(P({
            min: 0,
        ...
        default:
          ...
          switch (t.outType) {
            case "outside": {
              ...
              })) + t.moveCenter.x, t.position.y = Math.floor(P({
                min: -t.moveCenter.radius,
                max: t.moveCenter.radius
              })) + t.moveCenter.y;
              const {
  ...
  class rs {
    randomPosition(t, e, i) {
      const [s, o] = [e.width / 2, e.height / 2], n = ((t, e) => {
        const i = _() / 4,
          s = Math.atan(e / t * Math.tan(2 * Math.PI * i)),
          o = _();
        return o < .25 ? s : o < .5 ? Math.PI - s : o < .75 ? Math.PI + s : -s
      })(s, o), a = (h = n, (l = s) * (c = o) / Math.sqrt((c * Math.cos(h)) ** 2 + (l * Math.sin(h)) ** 2)), r = i ? a * Math.sqrt(_()) : a;
      var l, c, h;
      return {
        x: t.x + r * Math.cos(n),
        y: t.y + r * Math.sin(n)
  ...
  class ls {
    ...
    load(t) {
      t && (void 0 !== t.count && (this.count = t.count), void 0 !== t.delay && (this.delay = T(t.delay)), void 0 !== t.duration && (this.duration = T(t.duration)), void 0 !== t.wait && (this.wait = t.wait))
    }
  }
  class cs {
    constructor() {
    ...
    load(t) {
      void 0 !== t && (void 0 !== t.quantity && (this.quantity = T(t.quantity)), void 0 !== t.delay && (this.delay = T(t.delay)))
    }
  }
  class hs {
    constructor() {
  ...
  class ds {
    constructor() {
      this.autoPlay = !0, this.fill = !0, this.life = new ls, this.rate = new cs, this.shape = "square", this.startCount = 0
    }
    load(t) {
      t && (void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay), void 0 !== t.size && (this.size || (this.size = new hs), this.size.load(t.size)), void 0 !== t.direction && (this.direction = t.direction), this.domId = t.domId, void 0 !== t.fill && (this.fill = t.fill), this.life.load(t.life), this.name = t.name, this.particles = dt(t.particles, (t => st({}, t))), this.rate.load(t.rate), void 0 !== t.shape && (this.shape = t.shape), void 0 !== t.position && (this.position = {}, void 0 !== t.position.x && (this.position.x = T(t.position.x)), void 0 !== t.position.y && (this.position.y = T(t.position.y))), void 0 !== t.spawnColor && (void 0 === this.spawnColor && (this.spawnColor = new ke), this.spawnColor.load(t.spawnColor)), void 0 !== t.startCount && (this.startCount = t.startCount))
    }
  }
  class us {
    constructor(t, e, i, s, o) {
      this.emitters = e, this.container = i, this._calcPosition = () => B({
        ...
        for (let o = 0; o < t; o++) {
          ...
          if (this.spawnColor) {
            ...
            e && (this.spawnColor.h = this._setColorAnimation(e.h, this.spawnColor.h, 360), this.spawnColor.s = this._setColorAnimation(e.s, this.spawnColor.s, 100), this.spawnColor.l = this._setColorAnimation(e.l, this.spawnColor.l, 100)), t.color ? t.color.value = this.spawnColor : t.color = {
        ...
        if (this._paused) return;
        const t = void 0 !== this.options.life?.duration ? C(this.options.life.duration) : void 0;
      ...
      }, this._engine = t, this._currentDuration = 0, this._currentEmitDelay = 0, this._currentSpawnDelay = 0, this._initialPosition = o, s instanceof ds ? this.options = s : (this.options = new ds, this.options.load(s)), this._spawnDelay = 1e3 * C(this.options.life.delay ?? 0) / this.container.retina.reduceFactor, this.position = this._initialPosition ?? this._calcPosition(), this.name = this.options.name, this._shape = this._engine.emitterShapeManager?.getShape(this.options.shape), this.fill = this.options.fill, this._firstSpawn = !this.options.life.wait, this._startParticlesAdded = !1;
      let n = st({}, this.options.particles);
      n ??= {}, n.move ??= {}, n.move.direction ??= this.options.direction, this.options.spawnColor && (this.spawnColor = Et(this.options.spawnColor)), this._paused = !this.options.autoPlay, this._particlesOptions = n, this.size = this.options.size ?? (() => {
        const t = new hs;
        return t.load({
          height: 0,
          mode: "percent",
    ...
    resize() {
      ...
      this.position = t && tt(t, this.container.canvas.size, g.origin) ? t : this._calcPosition()
    }
    update(t) {
      this._paused || (this._firstSpawn && (this._firstSpawn = !1, this._currentSpawnDelay = this._spawnDelay ?? 0, this._currentEmitDelay = this._emitDelay ?? 0), this._startParticlesAdded || (this._startParticlesAdded = !0, this._emitParticles(this.options.startCount)), void 0 !== this._duration && (this._currentDuration += t.value, this._currentDuration >= this._duration && (this.pause(), void 0 !== this._spawnDelay && delete this._spawnDelay, this._immortal || this._lifeCount--, this._lifeCount > 0 || this._immortal ? (this.position = this._calcPosition(), this._spawnDelay = 1e3 * C(this.options.life.delay ?? 0) / this.container.retina.reduceFactor) : this._destroy(), this._currentDuration -= this._duration, delete this._duration)), void 0 !== this._spawnDelay && (this._currentSpawnDelay += t.value, this._currentSpawnDelay >= this._spawnDelay && (this._engine.dispatchEvent("emitterPlay", {
        container: this.container
  ...
  class ps {
    constructor(t, e) {
      this.container = e, this._engine = t, this.array = [], this.emitters = [], this.interactivityEmitters = {
        ...
        value: []
      }, e.getEmitter = t => void 0 === t || bt(t) ? this.array[t || 0] : this.array.find((e => e.name === t)), e.addEmitter = (t, e) => this.addEmitter(t, e), e.removeEmitter = t => {
  ...
  class ws {
    draw(t, e, i) {
      const s = -i,
        o = -i;
      t.moveTo(s, o + i / 2), t.quadraticCurveTo(s, o, s + i / 2, o), t.quadraticCurveTo(s + i, o, s + i, o + i / 2), t.quadraticCurveTo(s + i, o, s + 3 * i / 2, o), t.quadraticCurveTo(s + 2 * i, o, s + 2 * i, o + i / 2), t.quadraticCurveTo(s + 2 * i, o + i, s + 3 * i / 2, o + 3 * i / 2), t.lineTo(s + i, o + 2 * i), t.lineTo(s + i / 2, o + 3 * i / 2), t.quadraticCurveTo(s, o + i, s, o + i / 2)
    }
  }
  const bs = [0, 4, 2, 1],
    xs = [8, 8, 4, 2];
              ...
              if (bs[c] < a.height)
                for (let t = 0, e = 0;;) {
                  ...
                  if (i = g(r, o), r += o + 1, i === m) {
                    o = p + 1, l.length = m + 2;
                    for (let t = 0; t < l.length; t++) l[t] = t < m ? [t] : []
                  } else {
                    i >= l.length ? l.push(l[s].concat(l[s][0])) : s !== m && l.push(l[s].concat(l[i][0]));
                    for (let s = 0; s < l[i].length; s++) {
                      ...
                      u.data.set([o, n, r, h], bs[c] * a.width + xs[c] * e + t % (4 * a.width)), t += 4
                    }
                    l.length === 1 << o && o < 12 && o++
                  }
                  if (t === 4 * a.width * (e + 1) && (e++, bs[c] + xs[c] * e >= a.height)) break
                }
  ...
  const Ps = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d.]+%?\))|currentcolor/gi;
  async function Cs(t) {
    return new Promise((e => {
      ...
      t.element = i, i.addEventListener("load", (() => {
        ...
        t.element = void 0, t.error = !0, t.loading = !1, W().error(`${f} loading image: ${t.source}`), e()
      })), i.src = t.source
    }))
  }
  async function Ss(t) {
    if ("gif" === t.type) {
      ...
      try {
        t.gifData = await async function(t, e, i) {
          ...
          const c = 1 << 1 + (7 & r),
            h = a.nextByte();
          n.pixelAspectRatio = a.nextByte(), 0 !== n.pixelAspectRatio && (n.pixelAspectRatio = (n.pixelAspectRatio + 15) / 64), l && (n.globalColorTable = zs(a, c));
          const d = (() => {
            try {
  ...
  async function ks(t) {
    ...
    e.ok ? t.svgData = await e.text() : (W().error(`${f} Image not found`), t.error = !0), t.loading = !1
  }
  ...
  class Os {
    ...
    draw(t, e, i, s, o) {
      ...
      if (n) {
        if (t.globalAlpha = s, n.gif && n.gifData) {
          ...
          a.imageSmoothingQuality = "low", a.imageSmoothingEnabled = !1, a.clearRect(0, 0, s.width, s.height), void 0 === e.gifLoopCount && (e.gifLoopCount = n.gifLoopCount ?? 0);
          let r = e.gifFrame ?? 0;
          const l = {
              x: .5 * -n.gifData.width,
          ...
          switch (t.scale(i / n.gifData.width, i / n.gifData.height), c.disposalMethod) {
            case 4:
            case 5:
            case 6:
            case 7:
            case 0:
              a.drawImage(c.bitmap, c.left, c.top), t.drawImage(s, l.x, l.y), a.clearRect(0, 0, s.width, s.height);
              break;
            case 1:
              a.drawImage(c.bitmap, c.left, c.top), t.drawImage(s, l.x, l.y);
              break;
            case 2:
              a.drawImage(c.bitmap, c.left, c.top), t.drawImage(s, l.x, l.y), a.clearRect(0, 0, s.width, s.height), 0 === n.gifData.globalColorTable.length ? a.putImageData(n.gifData.frames[0].image, l.x + c.left, l.y + c.top) : a.putImageData(n.gifData.backgroundImage, l.x, l.y);
              break;
            case 3: {
              const e = a.getImageData(0, 0, s.width, s.height);
              a.drawImage(c.bitmap, c.left, c.top), t.drawImage(s, l.x, l.y), a.clearRect(0, 0, s.width, s.height), a.putImageData(e, 0, 0)
            }
          }
          if (e.gifTime += o.value, e.gifTime > c.delayTime) {
            if (e.gifTime -= c.delayTime, ++r >= n.gifData.frames.length) {
    ...
    particleInit(t, e) {
      ...
      n.loading ? setTimeout((() => {
        ...
        let t;
        t = n.svgData && o ? await Ts(n, s, o, e) : {
          color: o,
          data: n,
          element: n.element,
          gif: n.gif,
  ...
  async function Es(t, e = !0) {
    ...
    const i = new Ds(t);
    await t.addPlugin(i, e), await t.addShape(["image", "images"], new Os(t), e)
  }
  class Rs extends Re {
    constructor() {
      super(), this.sync = !1
  ...
  class As {
    ...
    init(t) {
      const e = this.container,
        i = t.options.life;
      i && (t.life = {
        delay: e.retina.reduceFactor ? C(i.delay.value) * (i.delay.sync ? 1 : _()) / e.retina.reduceFactor * 1e3 : 0,
        delayTime: 0,
        duration: e.retina.reduceFactor ? C(i.duration.value) * (i.duration.sync ? 1 : _()) / e.retina.reduceFactor * 1e3 : 0,
        time: 0,
        count: i.count
    ...
    update(t, e) {
      ...
      r && (i.delay = 1e3 * C(r.delay.value), i.duration = 1e3 * C(r.duration.value))
    }
  }
  class Bs {
    constructor() {
  ...
  class Xs {
    ...
    load(t) {
      t && (void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.value && (this.value = T(t.value)))
    }
  }
  class Ys {
    constructor() {
      this.darken = new Xs, this.enable = !1, this.enlighten = new Xs, this.mode = "vertical", this.speed = 25
    }
    load(t) {
      t && (void 0 !== t.backColor && (this.backColor = ce.create(this.backColor, t.backColor)), this.darken.load(t.darken), void 0 !== t.enable && (this.enable = t.enable), this.enlighten.load(t.enlighten), void 0 !== t.mode && (this.mode = t.mode), void 0 !== t.speed && (this.speed = T(t.speed)))
    }
  }
  class js {
      ...
      ! function(t) {
        ...
        if (e?.enable)
          if (t.roll = {
              ...
              angle: _() * Math.PI * 2,
              speed: C(e.speed) / 360
            }, e.backColor) t.backColor = Et(e.backColor);
  ...
  class Ns {
    ...
    load(t) {
      t && (void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed && (this.speed = T(t.speed)), void 0 !== t.decay && (this.decay = T(t.decay)), void 0 !== t.sync && (this.sync = t.sync))
    }
  }
  class Zs extends Re {
    constructor() {
      super(), this.animation = new Ns, this.direction = "clockwise", this.path = !1, this.value = 0
    }
    load(t) {
  ...
  class Qs {
    ...
    init(t) {
      ...
      const s = e.animation;
      s.enable && (t.rotate.decay = 1 - C(s.decay), t.rotate.velocity = C(s.speed) / 360 * this.container.retina.reduceFactor, s.sync || (t.rotate.velocity *= _())), t.rotation = t.rotate.value
    }
    isEnabled(t) {
      const e = t.options.rotate;
  ...
  class to {
    draw(t, e, i) {
      const s = e.sides,
        o = e.starInset ?? 2;
      t.moveTo(0, 0 - i);
      for (let e = 0; e < s; e++) t.rotate(Math.PI / s), t.lineTo(0, 0 - i * o), t.rotate(Math.PI / s), t.lineTo(0, 0 - i)
    }
    getSidesCount(t) {
      const e = t.shapeData;
      return Math.round(C(e?.sides ?? e?.nb_sides ?? 5))
  ...
  class io {
    draw(t, e, i, s) {
      ...
      t.globalAlpha = s, d ? t.fillText(a, p.x, p.y) : t.strokeText(a, p.x, p.y), t.globalAlpha = 1
    }
    getSidesCount() {
      return 12
    }
    async init(t) {
      ...
      if (eo.find((t => Z(t, e.particles.shape.type)))) {
        const t = eo.map((t => e.particles.shape.options[t])).find((t => !!t)),
          i = [];
        dt(t, (t => {
  ...
  class oo extends Re {
    constructor() {
      super(), this.animation = new so, this.direction = "clockwise", this.enable = !1, this.value = 0
    }
    load(t) {
  ...
  class no {
    ...
    init(t) {
      ...
      s?.enable && (t.tilt.decay = 1 - C(s.decay), t.tilt.velocity = C(s.speed) / 360 * this.container.retina.reduceFactor, s.sync || (t.tilt.velocity *= _()))
    }
    isEnabled(t) {
  ...
  class ao {
    ...
    load(t) {
      t && (void 0 !== t.angle && (this.angle = T(t.angle)), void 0 !== t.move && (this.move = T(t.move)))
    }
  }
  class ro {
    constructor() {
    ...
    load(t) {
      if (t && (void 0 !== t.distance && (this.distance = T(t.distance)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed))
  ...
  class lo {
    ...
    init(t) {
      ...
      t.wobble = e?.enable ? {
        ...
        angleSpeed: 0,
        moveSpeed: 0
      }, t.retina.wobbleDistance = C(e?.distance ?? 0) * this.container.retina.pixelRatio
    }
    isEnabled(t) {
  ...
  async function po(t) {
    if (!co) {
      if (ho) return new Promise((t => {
        const e = setInterval((() => {
          co && (clearInterval(e), t())
        }), 100)
      }));
      ho = !0, await Ki(t), await async function(t, e = !0) {
        t.emitterShapeManager || (t.emitterShapeManager = new ms(t)), t.addEmitterShape || (t.addEmitterShape = (e, i) => {
          t.emitterShapeManager?.addShape(e, i)
        });
        const i = new ys(t);
        await t.addPlugin(i, e), t.addEmitterShape("circle", new rs), t.addEmitterShape("square", new vs)
      }(t), await async function(t, e = !0) {
        await t.addPlugin(new $s(t), e)
      }(t), await async function(t, e = !0) {
        await t.addShape(["spade", "spades"], new ss, e), await t.addShape(["heart", "hearts"], new os, e), await t.addShape(["diamond", "diamonds"], new ns, e), await t.addShape(["club", "clubs"], new as, e)
      }(t), await async function(t, e = !0) {
        await t.addShape("heart", new ws, e)
      }(t), await Es(t), await Gs(t), await async function(t, e = !0) {
  ...
  async function mo(t, e) {
    let i, s;
    return await po(Vi), wt(t) ? (s = t, i = e ?? {}) : (s = "confetti", i = t), fo({
      id: s,
      options: i
    })
  }
  return mo.create = async (t, e) => {
    if (!t) return mo;
    await po(Vi);
    const i = t.getAttribute("id") || "confetti";
    return t.setAttribute("id", i), async (s, o) => {
      let n, a;
      return wt(s) ? (a = s, n = o ?? e) : (a = i, n = s), fo({
        id: a,
        canvas: t,
        options: n
      })
    }
  }, mo.version = Vi.version, X() || (window.confetti = mo), e
})()));

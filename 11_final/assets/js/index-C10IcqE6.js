...
var se = (e, r, t) => r in e ? ie(e, r, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: t
}) : e[r] = t;
var p = (e, r, t) => se(e, typeof r != "symbol" ? r + "" : r, t),
  T = (e, r, t) => r.has(e) || V("Cannot " + t);
var k = (e, r, t) => (T(e, r, "read from private field"), t ? t.call(e) : r.get(e)),
  R = (e, r, t) => r.has(e) ? V("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, t),
  z = (e, r, t, n) => (T(e, r, "write to private field"), n ? n.call(e, t) : r.set(e, t), t),
  F = (e, r, t) => (T(e, r, "access private method"), t);
import {
  ao as oe,
  ap as E,
  aq as P,
  ...
  as as X,
  at as N
} from "./index-DL7-oXj8.js";
import {
  S as ae
} from "./base-80a1f760-BZWMVNpc.js";
import {
  c as ce,
  g as G,
  r as U,
  ...
  b as ue,
  E as he
} from "./consoleHook-59e792cb-Bfj_hjOb.js";
var fe = Object.create,
  ...
  b = (e, r) => function() {
    return r || (0, e[Q(e)[0]])((r = {
      exports: {}
    }).exports, r), r.exports
  },
  ge = (e, r, t, n) => {
    if (r && typeof r == "object" || typeof r == "function")
      for (let s of Q(r)) !ve.call(e, s) && s !== t && q(e, s, {
        get: () => r[s],
        enumerable: !(n = pe(r, s)) || n.enumerable
      });
    return e
  },
  O = (e, r, t) => (t = e != null ? fe(me(e)) : {}, ge(!e || !e.__esModule ? q(t, "default", {
    value: e,
    enumerable: !0
  }) : t, e)),
  ye = (e, r, t) => (we(e, r + "", t), t),
  ...
  C = (e, r, t, n) => (H(e, r, "write to private field"), r.set(e, t), t),
      ...
      function r() {
        const t = (n, s) => {
          t.state = "pending", t.resolve = i => {
            ...
            if (t.state === "pending") return queueMicrotask(() => {
              t.state = "rejected"
      ...
      var r = te(),
        t = (o = class extends Promise {
          constructor(c = null) {
            ...
            p(this, "resolve");
            p(this, "reject");
            z(this, n, l), this.resolve = k(this, n).resolve, this.reject = k(this, n).reject
          }
          get state() {
  ...
  be = b({
    "../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/Emitter.js"(e) {
      ...
      var r = re(),
        t, n, s, i, o, a, c, l, h, f, v, w = class {
          constructor() {
            j(this, i), j(this, a), j(this, l), j(this, f), j(this, t, void 0), j(this, n, void 0), j(this, s, void 0), C(this, t, new Map), C(this, n, w.defaultMaxListeners), C(this, s, !1)
          }
        ...
        S = w;
      t = new WeakMap, n = new WeakMap, s = new WeakMap, i = new WeakSet, o = function(d) {
        return y(this, t).get(d) || []
      }, a = new WeakSet, c = function(d, u) {
        const m = d.indexOf(u);
        return m > -1 && d.splice(m, 1), []
      }, l = new WeakSet, h = function(d, u) {
        const m = (...M) => {
          this.removeListener(d, m), u.apply(this, M)
        };
        return m
      }, f = new WeakSet, v = function(d, u, m) {
        this.emit(d, u, m)
      }, ye(S, "defaultMaxListeners", 10), e.Emitter = S
    }
  }),
  Se = b({
...
function ne(e) {
  return function(t, ...n) {
    if (Ce === "true") {
      const s = () => t.includes("sender") ? `${Ae}sender` : t.includes("receiver") ? `${xe}receiver` : "",
        i = t.replace(/\[.+\]:/, "");
      `${Ue[e]}${e}${s()}${Fe}${i}`, [...n]
    }
  }
...
var I = ne("emulator"),
  We = class {
    constructor(e) {
      ...
      window.addEventListener("message", t), r.then(() => {
        ...
        const s = n.data;
        s.type != null && (I('[message-sender]: emitting "%s" event...', s.type, s.payload), this.emitter.dispatchEvent(new MessageEvent(s.type, {
          data: s.payload
        })))
      }
    }
    async handshake() {
      ...
      }, "*", [this.channel.port2]), this.on("internal/handshake/done", () => {
    ...
    on(e, r, t) {
      I('[message-sender]: add listener "%s"', e), this.emitter.addEventListener(e, n => {
    ...
    async send(e, ...r) {
      const t = new B.DeferredPromise,
        n = (0, Le.default)(),
        s = r[0] || {};
      I('[message-sender]: send "%s" (%s)', e, n, s), this.receiverPort.postMessage({
        type: e,
        payload: {
          operationId: n,
          payload: s
  ...
  Ne = class {
    ...
    async readFile(e, r) {
      const t = await this.channel.send("fs/readFile", {
        path: e,
        encoding: r
      }).catch(n => {
        throw new Error(g('Failed to read file at path "%s"', e), {
          cause: n
        })
      });
    ...
    async writeFile(e, r, t) {
      let n, s = !1;
      typeof t == "object" ? (n = t.encoding, s = !!t.recursive) : typeof t == "string" && (n = t), await this.channel.send("fs/writeFile", {
        path: e,
        content: r,
        encoding: n,
        recursive: s
      }).catch(i => {
        throw new Error(g('Failed to write file at path "%s"', e), {
          cause: i
        })
      })
    }
    async readdir(e) {
      const r = await this.channel.send("fs/readdir", {
        path: e
      }).catch(t => {
        throw new Error(g('Failed to read directory at path "%s"', e), {
          cause: t
        })
      });
    ...
    async mkdir(e, r) {
      ...
      await this.channel.send("fs/mkdir", {
        ...
        throw new Error(g('Failed to make directory at path "%s"', e), {
          cause: n
        })
      })
    }
    async stat(e) {
      const r = await this.channel.send("fs/stat", {
        path: e
      }).catch(t => {
        throw new Error(g('Failed to stat file at path "%s"', e), {
          cause: t
        })
      });
    ...
    async rm(e, r) {
      ...
      await this.channel.send("fs/rm", {
        ...
        throw new Error(g('Failed to remove file at path "%s"', e), {
          cause: s
        })
      })
    }
  ...
  He = class {
    constructor(e) {
      ...
      p(this, "stderr");
      p(this, "stdin");
      this.channel = e, this.state = "running", this.stdout = new K.Emitter, this.stderr = new K.Emitter, this.stdin = {
        write: r => {
    ...
    forwardStdEvents() {
      this.channel.on("worker/tty", e => {
        ...
        if (r.workerId === this.id) switch (r.payload.type) {
          case "out": {
    ...
    async runCommand(e, r, t = {}) {
      ...
      const n = await this.channel.send("shell/runCommand", {
        command: e,
        args: r,
        options: t
      });
    ...
    async kill() {
      L(this.id, 'Failed to run "kill" on a ShellProcess: there is no process running. Did you forget to run it?'), this.state = "idle", await this.channel.send("shell/exit", {
        id: this.id
      }).catch(e => {
        throw new Error(g('Failed to kill shell with ID "%s"', this.id), {
          cause: e
        })
      }), this.id = void 0
    }
  ...
  ze = class {
    ...
    async waitFor(e, r, t = Ve) {
      const n = new $e.DeferredPromise,
        s = setTimeout(() => {
          n.reject()
        }, t),
    ...
    async getByShellId(e, r) {
      return this.waitFor({
        sourceShellId: e
      }, t => t.sourceShellId === e, r).catch(t => {
        throw new Error(g('Failed to get shell by ID "%s"', e), {
          cause: t
        })
      })
    }
    async waitForPort(e, r) {
      return this.waitFor({
        port: e
      }, t => t.port === e, r).catch(t => {
        throw new Error(g("Failed to await port %d", e), {
          cause: t
        })
      })
    }
  },
  Ge = "https://nodebox-runtime.codesandbox.io",
  x = ne("emulator"),
  Je = class {
    constructor(e) {
      p(this, "channel", null);
      ...
      this.options = e, L(this.options.iframe, 'Failed to create a Nodebox: expected "iframe" argument to be a reference to an <iframe> element but got %j', this.options.iframe), this.url = this.options.runtimeUrl || Ge, this.isConnected = !1
    }
    async connect() {
      const {
        iframe: e,
      ...
      const t = new Y.DeferredPromise;
      this.url || t.reject(new Error("Nodebox URL is missing. Did you forget to provide it when creating this Nodebox instance?")), L(e.contentWindow, "Failed to create a MessageChannel with the Nodebox iframe: no content window found"), this.channel = new We(e.contentWindow);
      const n = new Y.DeferredPromise;
      return e.setAttribute("src", this.url), e.addEventListener("load", () => {
        n.resolve()
      }, {
        once: !0
    ...
    get fs() {
      return L(this.isConnected, 'Failed to access the File System API: consumer is not connected. Did you forget to run "connect()"?'), this.fileSystemApi ? this.fileSystemApi : (this.fileSystemApi = new Ne(this.channel), this.fileSystemApi)
    }
    get shell() {
      return L(this.isConnected, 'Failed to access the Shell API: consumer is not connected. Did you forget to run "connect()"?'), this.shellApi ? this.shellApi : (this.shellApi = new qe(this.channel), this.shellApi)
    }
    get preview() {
      return L(this.isConnected, 'Failed to access the Preview API: consumer is not connected. Did you forget to run "connect()"?'), this.previewApi ? this.previewApi : (this.previewApi = new ze(this.channel), this.previewApi)
    }
  },
  Ye = "INJECT_AND_INVOKE",
  Ke = "PREVIEW_LOADED";
    ...
    return P(this, function(a) {
      return t = e.contentWindow, N(t, "Failed to await preview iframe: no content window found"), n = 9e4, s = 20, i = 0, [2, new Promise(function(c, l) {
        var h = function() {
          ...
          if (i >= s) {
            l(X("Could not able to connect to preview."));
            return
          }
  ...
  Object.assign(window.history, {
    go: function(c) {
      ...
      if (l >= 0 && l <= n.length - 1) {
        ...
        i(w), window.dispatchEvent(new PopStateEvent("popstate", {
          state: v
        }))
      }
    },
    ...
    replaceState: function(c, l, h) {
      t.replaceState.call(window.history, c, l, h), n[s] = {
        state: c,
        url: h
...
var tt = [{
    ...
    code: "function consoleHook({ scope }) {" + ce + `
};`,
    id: "consoleHook"
  }, {
    code: et.toString(),
  ...
  at = function(e) {
    ...
    function r(t, n, s) {
      s === void 0 && (s = {});
      var i = e.call(this, t, n, A(A({}, s), {
        bundlerURL: s.bundlerURL
      })) || this;
      return i._modulesCache = new Map, i.messageChannelId = ue(), i._initPromise = null, i.emitter = new he, i.manageIframes(t), i.emulator = new Je({
    ...
    return r.prototype._init = function(t) {
      ...
      return E(this, void 0, void 0, function() {
        ...
        return P(this, function(i) {
          switch (i.label) {
            case 0:
              return i.trys.push([0, 5, , 6]), this.status = "initializing", this.dispatch({
                type: "start",
                firstLoad: !0
              }), this._initPromise || (this._initPromise = this._init(t)), [4, this._initPromise];
            case 1:
              return i.sent(), this.dispatch({
                type: "connected"
              }), [4, this.createShellProcessFromTask(t)];
            case 2:
      ...
      return E(this, void 0, void 0, function() {
        ...
        return P(this, function(o) {
          switch (o.label) {
            case 0:
              return n = U(t["/package.json"]), this.emulatorCommand = de(n), this.emulatorShellProcess = this.emulator.shell.create(), [4, this.emulatorShellProcess.on("exit", function(a) {
                i.dispatch({
                  type: "action",
                  action: "notification",
                  notificationType: "error",
                  title: X("Error: process.exit(".concat(a, ") called."))
                })
              })];
            case 1:
              return o.sent(), [4, this.emulatorShellProcess.on("progress", function(a) {
                ...
                if (a.state === "command_running" || a.state === "starting_command") {
                  i.dispatch({
                    type: "shell/progress",
                    data: A(A({}, a), {
                      command: [(c = i.emulatorCommand) === null || c === void 0 ? void 0 : c[0], (l = i.emulatorCommand) === null || l === void 0 ? void 0 : l[1].join(" ")].join(" ")
                    })
      ...
      return E(this, void 0, void 0, function() {
        ...
        return P(this, function(i) {
          switch (i.label) {
            ...
            case 1:
              return s = i.sent().url, this.iframePreviewUrl = s + ((n = this.options.startRoute) !== null && n !== void 0 ? n : ""), [2]
          }
        })
      })
      ...
      Qe(this.iframe, this.options), N(this.iframe.parentNode, "The given iframe does not have a parent."), this.emulatorIframe = document.createElement("iframe"), this.emulatorIframe.classList.add("sp-bridge-frame"), (n = this.iframe.parentNode) === null || n === void 0 || n.appendChild(this.emulatorIframe)
    }, r.prototype.setLocationURLIntoIFrame = function() {
      return E(this, void 0, void 0, function() {
        return P(this, function(t) {
          switch (t.label) {
            case 0:
              return this.iframePreviewUrl ? [4, Xe(this.iframe, this.iframePreviewUrl)] : [3, 2];
            case 1:
              t.sent(), t.label = 2;
            case 2:
              return [2]
      ...
      this.status = "done", this.dispatch({
        type: "done",
        compilatonError: !1
          ...
          switch (n.label) {
            case 0:
              return window.addEventListener("message", function(s) {
                s.data.type === Ke && rt(t.iframe, t.messageChannelId), s.data.type === "urlchange" && s.data.channelId === t.messageChannelId ? t.dispatch({
                  type: "urlchange",
                  url: s.data.url,
                  back: s.data.back,
                  forward: s.data.forward
                }) : s.data.channelId === t.messageChannelId && t.dispatch(s.data)
              }), [4, this.emulator.fs.watch(["*"], [".next", "node_modules", "build", "dist", "vendor", ".config", ".vuepress"], function(s) {
                return E(t, void 0, void 0, function() {
                  var i, o, a, c, l, h, f;
                  return P(this, function(v) {
                    switch (v.label) {
                      case 0:
                        return s ? (i = s, o = "newPath" in i ? i.newPath : "path" in i ? i.path : "", [4, this.emulator.fs.stat(o)]) : [2];
                      case 1:
          ...
          switch (n.label) {
            case 0:
              return this.emulatorShellProcess && this.emulatorCommand ? (this.dispatch({
                type: "start",
                firstLoad: !0
              }), this.status = "initializing", [4, this.emulatorShellProcess.kill()]) : [3, 3];
            case 1:
      ...
      if (((s = this.emulatorShellProcess) === null || s === void 0 ? void 0 : s.state) === "running") {
        Object.entries(i).forEach(function(o) {
          var a = o[0],
            c = o[1];
          (!n._modulesCache.get(a) || U(c) !== U(n._modulesCache.get(a))) && n.emulator.fs.writeFile(a, c, {
            recursive: !0
          })
        });
        return

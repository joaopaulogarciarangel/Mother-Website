(function(_, D) {
  typeof exports == "object" && typeof module < "u" ? D(exports) : typeof define == "function" && define.amd ? define(["exports"], D) : (_ = typeof globalThis < "u" ? globalThis : _ || self, D(_.UnicornStudio = {}))
})(this, function(_) {
  "use strict";
  var is = Object.defineProperty;
  var rs = (_, D, g) => D in _ ? is(_, D, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: g
  ...
  class it {
    constructor({
      ...
      this.type = "Renderer", this.alpha = e, this.antialias = t, this.premultipliedAlpha = s, this.depth = i, this.failIfMajorPerformanceCaveat = r, this.preserveDrawingBuffer = a, this.stencil = h, this.container = o, this.pixelRatio = l, this._renderingScale = d, this.production = u, this.onError = c, this.onSuccess = f, this.onContextLost = p, this.onContextRestored = m, this.onDisposed = v, this.onSceneChange = T, this.initState(), this.canvas = document.createElement("canvas");
      const S = {
        alpha: this.alpha,
...
`, this.gl.getShaderInfoLog(s)), F(a), g(this.type + ": Will use a default", i), this.createShader(t === this.gl.VERTEX_SHADER ? this.defaultVsCode : this.defaultFsCode, t)
      }
      return s
    }
    useNewShaders() {
  ...
  class Z {
    ...
    compose(e, t, s) {
      ...
      const r = t.elements[0],
        ...
        C = s.y,
        y = s.z;
      return i[0] = (1 - (m + T)) * k, i[1] = (f + M) * k, i[2] = (p - E) * k, i[3] = 0, i[4] = (f - M) * C, i[5] = (1 - (c + T)) * C, i[6] = (v + S) * C, i[7] = 0, i[8] = (p + E) * y, i[9] = (v - S) * y, i[10] = (1 - (c + m)) * y, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this
    }
    composeFromOrigin(e, t, s, i) {
      ...
      const a = t.elements[0],
        ...
        ie = (T - E) * O,
        B = (1 - (f + v)) * O;
      return r[0] = q, r[1] = P, r[2] = w, r[3] = 0, r[4] = R, r[5] = x, r[6] = z, r[7] = 0, r[8] = $, r[9] = ie, r[10] = B, r[11] = 0, r[12] = e.x + Y - (q * Y + R * U + $ * V), r[13] = e.y + U - (P * Y + x * U + ie * V), r[14] = e.z + V - (w * Y + z * U + B * V), r[15] = 1, this
    }
  }
  class A {
    constructor(e = 0, t = e) {
  ...
  class b {
    ...
    applyQuat(e) {
      const t = this._x,
        ...
        u = o * i + r * s - a * t,
        c = -r * t - a * s - h * i;
      return this._x = l * o + c * -r + d * -h - u * -a, this._y = d * o + c * -a + u * -r - l * -h, this._z = u * o + c * -h + l * -a - d * -r, this
    }
    project(e) {
  ...
  class ae {
    constructor(e, {
      ...
      if (this.renderer = e, this.gl = this.renderer.gl, this.uuid = Se(), this._globalParameters = {
          unpackAlignment: 4,
          flipY: !t,
          premultiplyAlpha: !1,
          ...
          width: 1,
          height: 1
        }, this.scale = new A(1), this.scale.onChange(() => this.resize()), this.offset = new A, this.offset.onChange(() => this.resize()), this._loader = i, this._sourceLoaded = !1, this._uploaded = !1, this._willUpdate = !1, this.shouldUpdate = !1, this._forceUpdate = !1, this.userData = {}, this._canDraw = !1, s) {
...
gl.LINEAR filtering will be used instead`), this.parameters.magFilter = this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.parameters.magFilter), this._state.magFilter = this.parameters.magFilter);
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(Ee.set(.001, .001)), e.equals(this.scale) || (this.scale.copy(e), this.resize())
    }
    setOffset(e) {
      if (!e.type || e.type !== "Vec2") {
  ...
  class gt {
    ...
    _initMesh() {
      this.uuid = Se(), this.loader = new pt(this.renderer, this, {
        sourcesLoaded: 0,
        initSourcesToLoad: 0,
        complete: !1,
        onComplete: () => {
...
`, r), i && i(r, a)
  ...
  class xt {
    constructor({
      ...
      this.position = new b, this.projectionMatrix = new Z, this.worldMatrix = new Z, this.viewMatrix = new Z, this._shouldUpdate = !1, this.setSize(), this.setPerspective(e, t, s, i, r, a)
    }
    setFov(e) {
  ...
  class He extends _t {
    constructor(e, t, {
      ...
      super(e, t, "Plane", {
        ...
        texturesOptions: f,
        crossOrigin: p
      }), this.gl && (this.index = this.renderer.planes.length, this.target = null, this.alwaysDraw = m, this._shouldDraw = !0, this.visible = v, this._transparent = T, this.drawCheckMargins = S, this.autoloadSources = E, this.watchScroll = M, this._updateMVMatrix = !1, this.camera = new xt({
        fov: k,
        width: this.renderer._boundingRect.width,
        height: this.renderer._boundingRect.height,
        pixelRatio: this.renderer.pixelRatio
      }), this.customScale = C, this._program.compiled && (this._initPlane(), this.renderer.scene.addPlane(this), this.renderer.planes.push(this)))
    }
    _programRestored() {
    ...
    _initTransformValues() {
      this.rotation = new b, this.rotation.onChange(() => this._applyRotation()), this.quaternion = new xe, this.relativeTranslation = new b, this.relativeTranslation.onChange(() => this._setTranslation()), this._translation = new b, this.scale = new b(1), this.scale.onChange(() => {
    ...
    _getNearPlaneIntersections(e, t, s) {
      ...
      if (s.length === 1) s[0] === 0 ? (t[0] = this._getIntersection(t[1], N.set(.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[3], H.set(-1, -.95, 0).applyMat4(i)))) : s[0] === 1 ? (t[1] = this._getIntersection(t[0], N.set(-.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[2], H.set(1, -.95, 0).applyMat4(i)))) : s[0] === 2 ? (t[2] = this._getIntersection(t[3], N.set(-.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[1], H.set(1, .95, 0).applyMat4(i)))) : s[0] === 3 && (t[3] = this._getIntersection(t[2], N.set(.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[0], H.set(-1, .95, 0).applyMat4(i))));
      else if (s.length === 2) s[0] === 0 && s[1] === 1 ? (t[0] = this._getIntersection(t[3], N.set(-1, -.95, 0).applyMat4(i)), t[1] = this._getIntersection(t[2], H.set(1, -.95, 0).applyMat4(i))) : s[0] === 1 && s[1] === 2 ? (t[1] = this._getIntersection(t[0], N.set(-.95, 1, 0).applyMat4(i)), t[2] = this._getIntersection(t[3], H.set(-.95, -1, 0).applyMat4(i))) : s[0] === 2 && s[1] === 3 ? (t[2] = this._getIntersection(t[1], N.set(1, .95, 0).applyMat4(i)), t[3] = this._getIntersection(t[0], H.set(-1, .95, 0).applyMat4(i))) : s[0] === 0 && s[1] === 3 && (t[0] = this._getIntersection(t[1], N.set(.95, 1, 0).applyMat4(i)), t[3] = this._getIntersection(t[2], H.set(.95, -1, 0).applyMat4(i)));
      else if (s.length === 3) {
        let r = 0;
        for (let a = 0; a < e.length; a++) s.includes(a) || (r = a);
        t = [t[r]], r === 0 ? (t.push(this._getIntersection(t[0], N.set(-.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], H.set(-1, .95, 0).applyMat4(i)))) : r === 1 ? (t.push(this._getIntersection(t[0], N.set(.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], H.set(1, .95, 0).applyMat4(i)))) : r === 2 ? (t.push(this._getIntersection(t[0], N.set(.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], H.set(1, -.95, 0).applyMat4(i)))) : r === 3 && (t.push(this._getIntersection(t[0], N.set(-.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], H.set(-1 - .95, 0).applyMat4(i))))
      } else
    ...
    mouseToPlaneCoords(e) {
      if (Ne.setAxisOrder(this.quaternion.axisOrder), Ne.equals(this.quaternion) && St.equals(this.transformOrigin)) return super.mouseToPlaneCoords(e);
      {
        const t = {
  ...
  class Me {
    constructor(e, {
      ...
      this.renderer = e, this.gl = this.renderer.gl, this.index = this.renderer.renderTargets.length, this._shaderPass = t, this._depth = s, this._shouldClear = i, this._maxSize = {
        ...
        minFilter: this.gl.LINEAR,
        magFilter: this.gl.LINEAR
      }, l), this._texturesOptions = l, this.userData = {}, this.uuid = Se(), this.renderer.renderTargets.push(this), this.renderer.onSceneChange(), this._initRenderTarget()
    }
    _initRenderTarget() {
    ...
    _createFrameBuffer() {
      this._frameBuffer = this.gl.createFramebuffer(), this.renderer.bindFrameBuffer(this, !0), this.textures.length ? (this.textures[0]._parent = this, this.textures[0]._restoreContext()) : new ae(this.renderer, this._texturesOptions).addParent(this), this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER, this.gl.COLOR_ATTACHMENT0, this.gl.TEXTURE_2D, this.textures[0]._sampler.texture, 0), this._depth && (this._depthBuffer = this.gl.createRenderbuffer(), this._bindDepthBuffer()), this.renderer.bindFrameBuffer(null)
    }
    getTexture() {
  ...
  class Ft extends He {
    constructor(e, t, {
      ...
      this.renderer.scene.removePlane(this), this.type = "PingPongPlane", this.renderer.scene.addPlane(this), this.readPass = new Me(e, {
        depth: !1,
        clear: !1,
        texturesOptions: p
      }), this.writePass = new Me(e, {
        depth: !1,
        clear: !1,
        texturesOptions: p
      }), this.createTexture({
  ...
  let ye, de, Ce = !1,
    ...
    ue, be = null,
    he;
  typeof document.hidden < "u" ? (ye = "hidden", de = "visibilitychange") : typeof document.msHidden < "u" ? (ye = "msHidden", de = "msvisibilitychange") : typeof document.webkitHidden < "u" && (ye = "webkitHidden", de = "webkitvisibilitychange");
  ...
  function Lt(n, e) {
    ...
    s.src = fe("aHR0cHM6Ly9hc3NldHMudW5pY29ybi5zdHVkaW8vbWVkaWEvbWFkZV9pbl91c19zbWFsbF93ZWIuc3Zn"), s.alt = fe("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv"), s.style = "width: 170px; height: auto;", t.appendChild(s), e.appendChild(t)
  }
  ...
  function Fe() {
    ...
    const e = t => {
      let s = !1;
      n.forEach(i => {
        i.isInView && i.initialized ? (i.rendering = !0, t - (i.lastTime || 0) >= i.frameDuration && !i.paused && (i.renderFrame(), i.lastTime = t), s = _.scenes.filter(r => r.getDynamicLayers().length > 0).length > 0) : i.rendering = !1
      }), (!ce || t - ce > 64) && (G = window.scrollY || window.pageYOffset, ne = G - Ae, Ae = G, ce = t, (ne > 1e3 || ne < 0 && !Ae && !G) && Le()), s ? (Yt(), ue = requestAnimationFrame(e)) : cancelAnimationFrame(ue)
    };
    n.length && (ue = requestAnimationFrame(e))
  }

  function ge(n, e, t) {
    return (n == null ? void 0 : n.type) === "Vec3" && (e == null ? void 0 : e.type) === "Vec3" ? new b(n._x + (e._x - n._x) * t, n._y + (e._y - n._y) * t, n._z + (e._z - n._z) * t) : (n == null ? void 0 : n.type) === "Vec2" && (e == null ? void 0 : e.type) === "Vec2" ? new A(n._x + (e._x - n._x) * t, n._y + (e._y - n._y) * t) : n + (e - n) * t
  }

  function ve(n, e) {
    return n.type === "Vec2" ? n = new A(n._x, e ? 1 - n._y : n._y) : n.type === "Vec3" && (n = new b(n._x, n._y, n._z)), n
  }
  ...
  function ze(n, e, t) {
    ...
    s.width = e * .01, s.height = t * .01;
    const i = s.getContext("2d");
    i.fillStyle = "rgba(0, 0, 0, 0)", i.fillRect(0, 0, e * .01, t * .01), be = s.toDataURL(), n.loadImage(be, {
      sampler: "uTexture"
    })
  }
  class Ut {
    constructor({
      ...
      L(this, "id", pe());
      this.prop = e, this.transition = i, this.complete = !1, this.progress = 0, this.uniformData = a, this.value = ve(t), this.endValue = s !== void 0 ? ve(s || 0) : null, this.lastTick = void 0, this.initialized = !1, this.startTime = null, this.breakpoints = r || [], this.loop = h, this.loopDelay = o
    }
    updateEffect(e, t) {
      ...
      if (this.loop !== "none") {
        const o = this.transition.duration + this.loopDelay,
          l = a % o;
        if (l > this.transition.duration) return !1;
        const d = l / this.transition.duration,
          u = Math.floor(a / o);
        let c = d;
        return this.loop === "reverse" && u % 2 === 1 && (c = 1 - d), this.progress = i(c), this.lastTick = s, ge(this.value, e, this.progress)
      }
      const h = Math.max(0, Math.min(1, a / this.transition.duration));
      return this.progress = i(h), this.progress === 0 ? !1 : (h >= 1 && (this.complete = !0, this.progress = 0), this.lastTick = s, this.complete ? !1 : ge(this.value, e, this.progress))
    }
    resetState() {
  ...
  class Vt {
    constructor({
      ...
      L(this, "id", pe());
      this.prop = e, this.progress = 0, this.momentum = r, this.range = s, this.offset = i, this.mode = h, this.delta = o, this.absScrollValue = l, this.uniformData = a, this.value = ve(t), this.lastTick = void 0, this.breakpoints = d || []
    }
    updateEffect(e, {
      top: t,
      height: s,
      ...
      if (i && (t -= G), this.mode === "scrollIntoView") {
        ...
        return this.lastTick !== void 0 && (o = Pe(o, this.lastTick, this.momentum * 2)), this.lastTick !== void 0 && Math.abs(this.lastTick - o) < 1e-4 ? !1 : (this.lastTick = o, ge(e, this.value, o))
      } else if (this.mode === "whileScrolling") {
        let r = ne * this.delta;
        return this.absScrollValue && (r = Math.abs(r)), this.lastTick !== void 0 && (r = Pe(r, this.lastTick, this.momentum * 2), Math.abs(r) < .001) ? !1 : (this.lastScrollPos = G, this.lastTick = r, ge(e, this.value, r))
      }
      return !1
    }
    resetState() {
  ...
  class Bt {
    constructor({
      ...
      L(this, "id", pe());
      this.prop = e, this.transition = s, this.progress = 0, this.rawProgress = 0, this.lastProgress = null, this.value = ve(t), this.uniformData = r, this.triggerOnElement = a !== void 0 ? a : 1, this.breakpoints = i || []
    }
    updateEffect(e, t, s) {
      var c;
      if (e === void 0) return !1;
      ...
      return this.progress = d, !t && !u ? !1 : (!t && this.transition.forwardsOnly && (this.progress = 0, this.rawProgress = 0), this.lastTick = r, this.lastEnterTime = t, u ? ge(e, this.value, this.progress) : !1)
    }
    resetState() {
      this.progress = 0
    }
  ...
  function Wt(n) {
    return n.forEach(e => {
      var t, s;
      for (let i in e.props)((t = e.props[i]) == null ? void 0 : t.type) === "Vec2" ? e.props[i] = new A(e.props[i]._x, e.props[i]._y) : ((s = e.props[i]) == null ? void 0 : s.type) === "Vec3" ? e.props[i] = new b(e.props[i]._x, e.props[i]._y, e.props[i]._z) : typeof e.props[i] == "object" && (e.props[i] = ee(e.props[i]))
    }), n
  }
  class Ye {
    constructor(e, t) {
      ...
      this.locked = e.locked || !1, this.aspectRatio = e.aspectRatio || 1, this.layerName = e.layerName || "", this.data = e.data || {}, this.userDownsample = e.userDownsample || 1, this.breakpoints = Wt(e.breakpoints || []), this.local.sceneId = t, this.local.id = pe(), this.states = {
    ...
    updateStateEffects() {
      var s, i, r, a;
      if (!this.states.appear.some(h => !h.complete) && !((s = this.states) != null && s.scroll.length) && !((i = this.states) != null && i.hover.length)) return;
      ...
      const e = this.state();
      (!this.local.cachedBreakpoint || this.local.cachedBreakpoint !== ((r = e.currentBreakpoint) == null ? void 0 : r.name)) && (this.local.cachedBreakpoint = (a = e.currentBreakpoint) == null ? void 0 : a.name);
      const t = h => !h.breakpoints || h.breakpoints.length === 0 ? !0 : h.breakpoints.find(o => o === this.local.cachedBreakpoint);
      e.isInView && (this.local.createdAt === null && (this.local.createdAt = performance.now()), this.states.appear.forEach(h => {
        if (!t(h)) return;
        let o = h.startTime || this.local.createdAt;
        if (!h.initialized) {
          const d = [...this.states.appear.filter(u => u.prop === h.prop)].sort((u, c) => (u.transition.delay || 0) - (c.transition.delay || 0))[0];
          (d == null ? void 0 : d.id) === h.id && (this.local.uniformUpdatesPool[h.prop] = h.value, this.local.hasUpdates = !0, this.local.updatedProps.add(h.prop)), h.initialized = !0, o || (h.startTime = performance.now())
        }
        e != null && e.pauseTime && (o += Math.abs(e == null ? void 0 : e.pauseTime));
        const l = h.updateEffect(this[h.prop], o);
        l !== !1 && (this.local.uniformUpdatesPool[h.prop] = l, this.local.hasUpdates = !0, this.local.updatedProps.add(h.prop)), this.isElement && h.complete && this.removeStateEffectProperty(h.prop)
      })), this.states.hover.forEach(h => {
        if (!t(h)) return;
        const o = h.updateEffect(this[h.prop], e.mouse.enterTime, this);
        o !== !1 && (this.local.uniformUpdatesPool[h.prop] = o, this.local.hasUpdates = !0, this.local.updatedProps.add(h.prop))
        ...
        l !== !1 && (this.local.uniformUpdatesPool[h.prop] = l, this.local.hasUpdates = !0, this.local.updatedProps.add(h.prop))
      }), this.local.hasUpdates && (this.getPlanes().forEach(h => {
        var o;
        for (let l of this.local.updatedProps) {
          const d = this.local.uniformUpdatesPool[l];
          d !== void 0 && ((o = h.uniforms[l]) == null ? void 0 : o.lastValue) !== d && (h.uniforms[l] && Te(d, h.uniforms[l], l), this.updateStateEffectProperty(l, d))
        }
  ...
  let Ie = class extends Ye {
    ...
    unpackage() {
      return this.effects = ee(this.effects), this.maskBackground = new b(this.maskBackground._x, this.maskBackground._y, this.maskBackground._z), this.unpackageType(), this
    }
    getPixelRatio() {
      const t = this.state();
  ...
  class Nt extends Ie {
    ...
    render() {
      ...
      let l = ((p = this.local.stateEffectProps) == null ? void 0 : p.borderRadius) ?? this.borderRadius,
        d = ((m = this.local.stateEffectProps) == null ? void 0 : m.strokeWidth) ?? this.strokeWidth,
        u = ((v = this.local.stateEffectProps) == null ? void 0 : v.gradientAngle) ?? this.gradientAngle,
        c = i - o.x * a,
        f = r - o.y * h;
      if (t.clearRect(0, 0, s.canvasWidth, s.canvasHeight), t.beginPath(), this.fitToCanvas) t.rect(0, 0, s.canvasWidth, s.canvasHeight), t.fillStyle = ke(t, {
        width: s.canvasWidth,
        height: s.canvasHeight
      }, this.fill, u, this.gradientType);
      else {
        if (t.save(), t.translate(c + a / 2, f + h / 2), t.rotate(this.rotation * 2 * Math.PI), t.translate(-a / 2, -h / 2), this.type === "rectangle") {
          let T = l * Math.min(Math.abs(a), Math.abs(h)) / 2;
          this.drawRoundedRect(t, 0, 0, a, h, T)
        ...
        t.fillStyle = ke(t, this.box(), this.fill, u, this.gradientType)
      }
  ...
  class Ht extends Ye {
    ...
    unpackage() {
      for (let t in this) this[t] && this[t].type && (this[t].type === "Vec2" ? this[t] = new A(this[t]._x, this[t]._y) : this[t].type === "Vec3" && (this[t] = new b(this[t]._x, this[t]._y, this[t]._z)));
      return this
    }
    getParent() {
    ...
    renderImage() {
      ...
      if (this.fitToCanvas) {
        ...
        let v = a / 2,
          ...
          S = i - p + v,
          E = r - m + T;
        t.translate(S, E), t.rotate(f), t.drawImage(this.local.img, -v, -T, a, h), t.restore()
      }
    }
    render() {}
  }
  class jt extends Ie {
    ...
    getAbsoluteFontValues(t) {
      ...
      const s = ((o = (h = this.local) == null ? void 0 : h.stateEffectProps) == null ? void 0 : o.fontSize) || this.fontSize,
        ...
        r = ((c = (u = this.local) == null ? void 0 : u.stateEffectProps) == null ? void 0 : c.letterSpacing) || this.letterSpacing,
    ...
    render() {
      ...
      const a = le(this.anchorPoint),
        h = ((q = (V = this.local) == null ? void 0 : V.stateEffectProps) == null ? void 0 : q.rotation) || this.rotation;
      let o = this.state(),
        l = this.height,
        d = s - a.x * r,
        u = i - a.y * l,
      ...
      const S = t.measureText("m").width;
      r = Math.max(r, S), t.save();
      let E = d + r / 2,
        M = u + l / 2;
      t.translate(E, M), t.rotate(h * 360 * Math.PI / 180), t.translate(-E, -M), this.textAlign === "center" && (d += r / 2), this.textAlign === "right" && (d += r), t.fillStyle = ke(t, this.box(), this.fill, this.gradientAngle, this.gradientType);
      const k = (P, w, R, x, z, $, ie) => {
          let B = w.split("").reduce((I, K, ss) => I + P.measureText(K).width + (ss < w.length - 1 ? z : 0), 0),
            W;
          if ($ === "center" ? W = R + (ie - B) / 2 - ie / 2 : W = R, $ === "right")
            for (let I = w.length - 1; I >= 0; I--) {
              const K = w[I];
              W -= P.measureText(K).width, P.fillText(K, W, x), I > 0 && (W -= z)
            } else
              for (let I = 0; I < w.length; I++) P.fillText(w[I], W, x), W += P.measureText(w[I]).width + z
        },
        C = (P, w) => {
          let R = u + p * w + p / 2 + f / 3;
          this.isSafari ? k(t, P, d, R, m, this.textAlign, r) : t.fillText(P, d, R)
        },
        y = this.textContent ? this.textContent.split(`
`) : [""];
      let O = y.length;
      const Y = (P, w, R) => w.split("").reduce((z, $, ie) => (z += P.measureText($).width, ie < w.length - 1 && (z += R), z), 0);
      for (let P = 0; P < O; P++) {
        let w = "",
          R = y[P].split(/(\s|\n)/);
        for (let x = 0; x < R.length; x++) {
          const z = R[x],
            $ = w + z;
          if ((this.isSafari && m ? Y(t, $, m) : t.measureText($).width) > r || z === `
`) {
...
` && y.push(z);
              ...
              R.slice(x + 1).length > 0 && (y[W] += R.slice(x + 1).join(""))
            }
            break
          } else w = $;
          x === R.length - 1 && (y[P] = w.trim())
        }
      }
      y.forEach((P, w) => {
        C(P, c), w < y.length - 1 && c++
      }), t.translate(-(d + r / 2), -(u + l / 2)), t.restore(), this.height = p * c + p
    }
  }

  function $e() {
    document[ye] ? (cancelAnimationFrame(ue), _.scenes.forEach(n => {
      n.pauseTime = performance.now()
    })) : (Fe(), _.scenes.forEach(n => {
      n.pauseTime = n.pauseTime - performance.now(), n.curtain.planes.forEach(e => {
        e.videos.forEach(t => {
          t.play()
        })
      })
  ...
  function Xt() {
    re = window.innerHeight || document.documentElement.clientHeight, J = window.innerWidth || document.documentElement.clientWidth, _.scenes.filter(n => n.initialized).forEach(n => {
      n.refresh()
    }), Le()
  }
  ...
  function Le() {
    _.scenes.filter(n => n.getDynamicLayers().length).forEach(n => {
      let e = n.element.getBoundingClientRect();
      n.scrollY = G, n.lastBbox && (Math.abs(e.top - n.lastBbox.top) === 0 && ne > 0 ? (n.fixedCounter = (n.fixedCounter || 0) + 1, n.fixedCounter > 3 && (n.isFixed = !0)) : n.fixedCounter = 0), n.lastBbox = n.bbox, n.bbox = e
    })
  }
  ...
  function Qe(n) {
    ...
    const s = performance.now();
    (!ce || s - ce > 64) && Le(), e.forEach(i => {
      qe(i.element, i.bbox, 100) ? i.isInView || (i.isInView = !0, i.pauseTime = i.pauseTime - performance.now(), i.curtain.resize(), i.lazyLoad && !i.initialized && !i.initializing && i.initializePlanes()) : i.isInView && (i.isInView = !1, i.pauseTime = performance.now())
    })
  }
  ...
  function Yt() {
    _.scenes.forEach(n => {
      var e, t, s, i, r, a;
      if (n.isInView && ((t = (e = n.curtain) == null ? void 0 : e.planes) != null && t.find(h => h.uniforms.mousePos)) && !(we() && ((i = (s = n.interactivity) == null ? void 0 : s.mouse) != null && i.disableMobile) || (a = (r = n.interactivity) == null ? void 0 : r.mouse) != null && a.disabled)) {
        ...
        let h = n.isFixed ? n.bbox.top : n.bbox.top + n.scrollY,
          o = n.bbox.left;
        n.mouse.page.x > o && n.mouse.page.y > h && n.mouse.page.x < n.lastBbox.width + o && n.mouse.page.y < n.lastBbox.height + h ? n.mouse.enterTime || (n.mouse.enterTime = performance.now()) : n.mouse.enterTime = null
      }
    })
  }

  function Ze(n) {
    _.scenes.filter(e => e.isInView).forEach(e => {
      e.mouse.page.x = 99999999999, e.mouse.page.y = 99999999999, e.mouse.enterTime = null
    })
  }

  function Re(n) {
    _.scenes.filter(e => e.isInView && e.initialized).forEach(e => {
      let t = e.bbox;
      const s = performance.now();
      Math.abs(ne) > 1 && s - e.lastBboxTime > 64 && (t = e.element.getBoundingClientRect(), e.lastBbox = e.bbox, e.bbox = t, e.lastBboxTime = s);
      let i, r;
      n.targetTouches ? (i = n.targetTouches[0].pageX, r = n.targetTouches[0].pageY) : (i = n.pageX, r = n.pageY), e.isFixed && (e.scrollY = 0, n.targetTouches ? r = n.targetTouches[0].clientY : r = n.clientY);
      const a = i - t.left,
        h = r - (t.top + (e.isFixed ? 0 : G));
      e.mouse.page.x = i, e.mouse.page.y = r, e.mouse.movePos.x = a * .5, e.mouse.movePos.y = h * .5, e.mouse.movedInView = !0
    })
  }
  _.scenes = [];
  class $t {
    constructor(e) {
      ...
      this.id = e.id, this.breakpoints = [{
        ...
        max: 575,
        min: 0
      }], this.projectId = e.projectId, this.canvasWidth = e.width || e.element.offsetWidth || J, this.canvasHeight = e.height || e.element.offsetHeight || re, this.curtain = void 0, this.curtainRafId = void 0, this.dpi = +e.dpi || Math.min(1.5, window.devicePixelRatio), this.element = e.element, this.fps = e.fps || 60, this.name = e.name, this.frameDuration = Math.floor(1e3 / (e.fps || 60)), this.layers = e.layers, this.lazyLoad = e.lazyLoad, this.initialized = !1, this.lasTick = null, this.lastTime = 0, this.rendering = !1, this.bbox = {}, this.isFixed = e.fixed || window.getComputedStyle(this.element).position === "fixed", this.interactivity = {
        mouse: {
          disableMobile: !1,
          disabled: !1
        }
    ...
    preloadTextures() {
      this.layers.forEach(e => {
        ...
        if (e.isElement) e.local.canvas ? this.textureLoader.loadCanvas(e.local.canvas, {
          ...
          const u = ((r = e == null ? void 0 : e.texture) == null ? void 0 : r.src) || ((h = (a = e == null ? void 0 : e.data) == null ? void 0 : a.texture) == null ? void 0 : h.src),
            c = ((o = e == null ? void 0 : e.texture) == null ? void 0 : o.sampler) || ((d = (l = e == null ? void 0 : e.data) == null ? void 0 : l.texture) == null ? void 0 : d.sampler) || "uTexture";
          this.local.preloadedTextures[u] ? this.local.preloadedTextures[u].count++ : (this.local.preloadedTextures[u] = {
            count: 1,
            texture: null
          }, this.textureLoader.loadImage(u, {
            sampler: c,
    ...
    destroy() {
      ...
      (e = this.curtain) != null && e.gl && (this.curtain.dispose(), this.curtain = null), this.element && (this.element.removeAttribute("data-us-initialized"), this.element.removeAttribute("data-scene-id"), (t = this.element.querySelector("canvas")) == null || t.remove(), this.element.querySelectorAll("[data-us-text]").forEach(s => {
        s.remove()
      })), this.layers.filter(s => s.dispose).forEach(s => s.dispose()), this.layers = [], _.scenes = _.scenes.filter(s => s.id !== this.id), _.scenes.length || De()
    }
    resize() {
    ...
    refresh() {
      this.initialized = !1, this.layers.forEach(e => {
        ...
        this.curtain && (this.curtain.planes.forEach(e => {
          e._canDraw = !0
        }), this.scrollY = G, this.resize(), this.handlePlaneCreation())
      })
    }
    getDynamicLayers() {
    ...
    getSplitOrderedItems() {
      ...
      if (s) {
        ...
        for (; s && !oe(s) && !r && !a;) t++, s = e[t], s && (i = s.parentLayer ? s.getParent() : null, r = i && oe(i), a = i && i.effects && i.effects.length && i.getChildEffectItems().filter(h => oe(h)).length);
        return {
    ...
    getPlaneParams(e, t) {
      var h, o, l, d, u;
      let s = (h = e.data) != null && h.heightSegments || (o = e.data) != null && o.widthSegments || ["noiseField", "bulge"].includes(e.type) ? 500 : 1;
      const i = {
        resolution: {
          name: "uResolution",
          type: "2f",
          value: new A(this.canvasWidth, this.canvasHeight)
        },
        mousePos: {
          name: "uMousePos",
          type: "2f",
      ...
      if (e.states && [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach(c => {
        ...
        for (let c in e.data.uniforms) {
          ...
          i[c] = e.data.uniforms[c], ((d = f.value) == null ? void 0 : d.type) === "Vec3" ? i[c].value = new b(f.value._x, f.value._y, f.value._z) : ((u = f.value) == null ? void 0 : u.type) === "Vec2" ? i[c].value = new A(f.value._x, f.value._y) : typeof f.value == "object" && (i[c].value = ee(f.value))
        }
      return {
        fragmentShader: r,
        vertexShader: a,
    ...
    handleMediaTextures(e, t, s) {
      ...
      if ([t.texture, (i = t.data) == null ? void 0 : i.texture].filter(r => r == null ? void 0 : r.src).forEach(r => {
          ...
          if ((h = t.compiledFragmentShaders[s.passIndex ?? 0]) == null ? void 0 : h.includes(r.sampler)) {
            ...
            o != null && o.texture ? (o.count > 1 ? (X(e, r.sampler, o.texture), o.count--) : e.addTexture(o.texture), e.userData.textureLoaded = !0) : this.textureLoader.loadImage(r.src, {
              premultipliedAlpha: !1,
              sampler: r.sampler
            }, l => {
    ...
    handleEffectPlane(e, t, s) {
      ...
      if (a && h != null && h.includes("uPingPongTexture") && X(i, "uPingPongTexture", a.getTexture()), r ? X(i, "uTexture", r.getTexture()) : ze(i, this.canvasWidth, this.canvasHeight), h != null && h.includes("uBgTexture")) {
        let l = this.getRenderTargets()[t - (1 + s.passIndex)];
        l && X(i, "uBgTexture", l.getTexture())
      }
    ...
    handleElementPlane(e, t) {
      ...
      let a = this.getRenderTargets()[t - 1],
        h = r[r.indexOf(e) - 2],
        o;
      if (e.mask && h && (o = h.local.lastTarget), i.length || (s.textures.length = 0), a || ze(s, this.canvasWidth, this.canvasHeight), a && i.length ? X(s, "uTexture", a.getTexture()) : s && s.addTexture(e.preloadedCanvasTexture), a) {
        if (i.length) {
          let l = i.reduce((d, u) => d + u.getPlanes().length, 0);
          a = this.getRenderTargets()[t - (1 + l)]
        }
        a && (X(s, "uBgTexture", a.getTexture()), o && e.mask && X(s, "uPreviousLayerTexture", o.getTexture()))
      }
    }
    handleChildEffectPlane(e, t, s) {
      ...
      e.type === "custom" && X(i, "uCustomTexture", this.getRenderTargets()[t]), this.handleMediaTextures(i, e, s)
    }
    createPlanes() {
    ...
    setInitialEffectPlaneUniforms(e, t, s, i) {
      ...
      if (!e.userData.initialUniformsSet || !e.userData.isReady) {
        for (let a in e.uniforms)(r = t.states) != null && r.scroll.some(h => h.prop === a) || (t.local.bpProps && a in t.local.bpProps ? Te(t.local.bpProps[a], e.uniforms[a], a) : a in t && Te(t[a], e.uniforms[a], a));
    ...
    calculateItemMouseValues(e) {
      ...
      return this.local.mouseValuePool || (this.local.mouseValuePool = new A(.5)), this.local.mouseValuePool.x = i.x, this.local.mouseValuePool.y = i.y, this.local.mouseValuePool
    }
    getMousePosWithMomentum(e, t, s) {
      ...
      const h = e.local.lastMousePos.x * t,
        ...
        d = Math.abs(r - o),
        u = .001;
      return l < u && d < u || (i = Pe(i, h, a * 2), r = Pe(r, o, a * 2), e.local.lastMousePos.x = i / t, e.local.lastMousePos.y = 1 - r / s), e.local.lastMousePos
    }
    setEffectPlaneUniforms(e, t) {
      var r, a, h;
      let s = ((r = t.local.stateEffectProps) == null ? void 0 : r.speed) ?? t.speed ?? 1;
      if (t.animating && e.uniforms.time && (e.uniforms.time.value += s * 60 / this.fps), we() && ((h = (a = this.interactivity) == null ? void 0 : a.mouse) != null && h.disableMobile)) return !1;
    ...
    handlePlaneCreation() {
      this.initialized = !0, this.initializing = !1, this.rendering || this.renderNFrames(2), this.waitForAssetsAndDisablePlanes(), Fe()
    }
    waitForAssetsAndDisablePlanes() {
      this.layers.some(t => (t.layerType === "image" || t.layerType === "text") && !t.local.loaded || Object.values(this.local.preloadedTextures).some(s => s === null)) ? setTimeout(() => this.waitForAssetsAndDisablePlanes(), 64) : (this.layers.filter(t => t.preloadedCanvasTexture).forEach(t => {
  ...
  function Qt() {
    te(window, "scroll", Qe), we() ? te(window, "touchmove", Re) : te(window, "mousemove", Re), te(window, "routeChange", Xe), te(document, "mouseleave", Ze), he = zt(Xt, 16), we() ? te(window, "orientationchange", he) : te(window, "resize", he), te(document, de, $e), Ce = !0
  }

  function De() {
    se(window, "mousemove", Re), se(window, "touchmove", Re), se(window, "scroll", Qe), se(window, "routeChange", Xe), se(document, "mouseleave", Ze), he && (se(window, "resize", he), se(window, "orientationchange", he)), se(document, de, $e), Ce = !1
  }
  ...
  function Je(n) {
    ...
    return new Promise((s, i) => {
      Kt(e, t, n.filePath, i, n.production).then(r => {
        ...
        c.curtain.canvas.innerText = n.altText || "", c.curtain.canvas.setAttribute("aria-label", n.ariaLabel || "Unicorn Studio Scene"), c.curtain.canvas.setAttribute("role", "img");
        let f = a[fe("ZnJlZVBsYW4=")];
        (f || a[fe("aW5jbHVkZUxvZ28=")]) && Lt(o, h), f && console.log(fe("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")), _.scenes.push(c), c.layers = u, c.preloadTextures(), c.setInteractiveParams(n, a), c.isInView = c.isFixed || qe(c.element, c.bbox, 50), (!c.lazyLoad || c.isInView) && c.initializePlanes(), Ce || Qt(), s(c)
      }).catch(r => {
        console.error(r), i(r)
      })
    })
  ...
  function ts() {
    return es() ? new Promise((n, e) => {
      ...
      t.filter(s => !s.getAttribute("data-us-initialized")).forEach((s, i) => {
        const r = j(s, "data-us-project"),
          a = j(s, "data-us-project-src"),
          h = j(s, "data-us-dpi"),
          o = j(s, "data-us-scale"),
          l = j(s, "data-us-lazyload"),
          d = j(s, "data-us-production"),
          u = j(s, "data-us-fps"),
          c = j(s, "data-us-alttext"),
          f = j(s, "data-us-arialabel"),
          p = j(s, "data-us-disablemobile"),
          m = j(s, "data-us-disablemouse"),
          v = j(s, "data-us-fixed");
        s.setAttribute("data-us-initialized", !0), Je({
          projectId: a ? null : r,
          filePath: a,
          element: s,
          dpi: +h,
  ...
  _.addScene = Je, _.destroy = Jt, _.init = ts, _.unbindEvents = De, Object.defineProperty(_, Symbol.toStringTag, {
    value: "Module"
  })
});

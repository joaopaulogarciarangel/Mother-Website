(function(_, D) {
  ...
  class it {
    constructor({
      ...
      this.type = "Renderer", this.alpha = e, this.antialias = t, this.premultipliedAlpha = s, this.depth = i, this.failIfMajorPerformanceCaveat = r, this.preserveDrawingBuffer = a, this.stencil = h, this.container = o, this.pixelRatio = l, this._renderingScale = d, this.production = u, this.onError = c, this.onSuccess = f, this.onContextLost = p, this.onContextRestored = m, this.onDisposed = T, this.onSceneChange = S, this.initState(), this.canvas = document.createElement("canvas");
      const R = {
        alpha: this.alpha,
  ...
  class Z {
    ...
    compose(e, t, s) {
      ...
      const r = t.elements[0],
        ...
        C = s.y,
        y = s.z;
      return i[0] = (1 - (m + S)) * k, i[1] = (f + M) * k, i[2] = (p - E) * k, i[3] = 0, i[4] = (f - M) * C, i[5] = (1 - (c + S)) * C, i[6] = (T + R) * C, i[7] = 0, i[8] = (p + E) * y, i[9] = (T - R) * y, i[10] = (1 - (c + m)) * y, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this
    }
    composeFromOrigin(e, t, s, i) {
      ...
      const a = t.elements[0],
        ...
        ie = (S - E) * O,
        B = (1 - (f + T)) * O;
      return r[0] = q, r[1] = P, r[2] = w, r[3] = 0, r[4] = v, r[5] = x, r[6] = z, r[7] = 0, r[8] = Y, r[9] = ie, r[10] = B, r[11] = 0, r[12] = e.x + X - (q * X + v * U + Y * V), r[13] = e.y + U - (P * X + x * U + ie * V), r[14] = e.z + V - (w * X + z * U + B * V), r[15] = 1, this
    }
  }
  class A {
    constructor(e = 0, t = e) {
...
`, r), i && i(r, a)
  ...
  class He extends _t {
    constructor(e, t, {
      ...
      super(e, t, "Plane", {
        ...
        texturesOptions: f,
        crossOrigin: p
      }), this.gl && (this.index = this.renderer.planes.length, this.target = null, this.alwaysDraw = m, this._shouldDraw = !0, this.visible = T, this._transparent = S, this.drawCheckMargins = R, this.autoloadSources = E, this.watchScroll = M, this._updateMVMatrix = !1, this.camera = new xt({
        fov: k,
    ...
    _initTransformValues() {
      this.rotation = new b, this.rotation.onChange(() => this._applyRotation()), this.quaternion = new _e, this.relativeTranslation = new b, this.relativeTranslation.onChange(() => this._setTranslation()), this._translation = new b, this.scale = new b(1), this.scale.onChange(() => {
  ...
  let xe, de, Ce = !1,
    ...
    ue, ye = null,
    he;
  typeof document.hidden < "u" ? (xe = "hidden", de = "visibilitychange") : typeof document.msHidden < "u" ? (xe = "msHidden", de = "msvisibilitychange") : typeof document.webkitHidden < "u" && (xe = "webkitHidden", de = "webkitvisibilitychange");
  ...
  function ze(n, e, t) {
    ...
    i.fillStyle = "rgba(0, 0, 0, 0)", i.fillRect(0, 0, e * .01, t * .01), ye = s.toDataURL(), n.loadImage(ye, {
      sampler: "uTexture"
    })
  }
  class Ut {
    constructor({
      ...
      L(this, "id", pe());
      this.prop = e, this.transition = i, this.complete = !1, this.progress = 0, this.uniformData = a, this.value = ve(t), this.endValue = s !== void 0 ? ve(s || 0) : null, this.lastTick = void 0, this.initialized = !1, this.startTime = null, this.breakpoints = r || []
    }
    updateEffect(e, t) {
      ...
      return this.progress = i(a), this.progress === 0 ? !1 : (a >= 1 && (this.complete = !0, this.progress = 0), this.lastTick = s, this.complete ? !1 : we(this.value, e, this.progress))
    }
    resetState() {
  ...
  class Vt {
    ...
    updateEffect(e, {
      ...
      if (i && (t -= G), this.mode === "scrollIntoView") {
        ...
        return this.lastTick !== void 0 && (o = be(o, this.lastTick, this.momentum * 2)), this.lastTick !== void 0 && Math.abs(this.lastTick - o) < 1e-4 ? !1 : (this.lastTick = o, we(e, this.value, o))
      } else if (this.mode === "whileScrolling") {
        let r = ne * this.delta;
        return this.absScrollValue && (r = Math.abs(r)), this.lastTick !== void 0 && (r = be(r, this.lastTick, this.momentum * 2), Math.abs(r) < .001) ? !1 : (this.lastScrollPos = G, this.lastTick = r, we(e, this.value, r))
      }
      return !1
    }
    resetState() {
  ...
  class Bt {
    ...
    updateEffect(e, t, s) {
      ...
      return this.progress = d, !t && !u ? !1 : (!t && this.transition.forwardsOnly && (this.progress = 0, this.rawProgress = 0), this.lastTick = r, this.lastEnterTime = t, u ? we(e, this.value, this.progress) : !1)
    }
    resetState() {
      this.progress = 0
    }
  ...
  class Nt extends Ie {
    ...
    render() {
      ...
      if (t.clearRect(0, 0, s.canvasWidth, s.canvasHeight), t.beginPath(), this.fitToCanvas) t.rect(0, 0, s.canvasWidth, s.canvasHeight), t.fillStyle = ke(t, {
        ...
        if (t.save(), t.translate(u + a / 2, c + h / 2), t.rotate(this.rotation * 2 * Math.PI), t.translate(-a / 2, -h / 2), this.type === "rectangle") {
  ...
  class jt extends Ie {
    ...
    render() {
      ...
      t.clearRect(0, 0, o.canvasWidth, o.canvasHeight), t.font = `${T} ${S} ${f}px/${p}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`, this.isSafari || (t.textAlign = this.textAlign, t.letterSpacing = m + "px");
...
`) : [""];
      let O = y.length;
      const X = (P, w, v) => w.split("").reduce((z, Y, ie) => (z += P.measureText(Y).width, ie < w.length - 1 && (z += v), z), 0);
      for (let P = 0; P < O; P++) {
        let w = "",
          v = y[P].split(/(\s|\n)/);
        for (let x = 0; x < v.length; x++) {
          const z = v[x],
            Y = w + z;
          if ((this.isSafari && m ? X(t, Y, m) : t.measureText(Y).width) > r || z === `
`) {
...
` && y.push(z);
  ...
  function $e() {
    document[xe] ? (cancelAnimationFrame(ue), _.scenes.forEach(n => {
  ...
  function Yt() {
    _.scenes.forEach(n => {
      var e, t, s, i;
      if (n.isInView && ((t = (e = n.curtain) == null ? void 0 : e.planes) != null && t.find(r => r.uniforms.mousePos)) && !(Pe() && ((i = (s = n.interactivity) == null ? void 0 : s.mouse) != null && i.disableMobile))) {
        ...
        let r = n.isFixed ? n.bbox.top : n.bbox.top + n.scrollY,
          a = n.bbox.left;
        n.mouse.page.x > a && n.mouse.page.y > r && n.mouse.page.x < n.lastBbox.width + a && n.mouse.page.y < n.lastBbox.height + r ? n.mouse.enterTime || (n.mouse.enterTime = performance.now()) : n.mouse.enterTime = null
      }
    })
  }
  ...
  class $t {
    ...
    handleMediaTextures(e, t, s) {
      ...
      if ([t.texture, (i = t.data) == null ? void 0 : i.texture].filter(r => r == null ? void 0 : r.src).forEach(r => {
          ...
          if ((h = t.compiledFragmentShaders[s.passIndex ?? 0]) == null ? void 0 : h.includes(r.sampler)) {
            ...
            o != null && o.texture ? (o.count > 1 ? (j(e, r.sampler, o.texture), o.count--) : e.addTexture(o.texture), e.userData.textureLoaded = !0) : this.textureLoader.loadImage(r.src, {
              premultipliedAlpha: !1,
              sampler: r.sampler
            }, l => {
    ...
    handleEffectPlane(e, t, s) {
      ...
      if (a && h != null && h.includes("uPingPongTexture") && j(i, "uPingPongTexture", a.getTexture()), r ? j(i, "uTexture", r.getTexture()) : ze(i, this.canvasWidth, this.canvasHeight), h != null && h.includes("uBgTexture")) {
    ...
    handleElementPlane(e, t) {
      ...
      let a = this.getRenderTargets()[t - 1],
        h = r[r.indexOf(e) - 2],
        o;
      if (e.mask && h && (o = h.local.lastTarget), i.length || (s.textures.length = 0), a || ze(s, this.canvasWidth, this.canvasHeight), a && i.length ? j(s, "uTexture", a.getTexture()) : s && s.addTexture(e.preloadedCanvasTexture), a) {
        if (i.length) {
    ...
    getMousePosWithMomentum(e, t, s) {
      ...
      const h = e.local.lastMousePos.x * t,
        ...
        d = Math.abs(r - o),
        u = .001;
      return l < u && d < u || (i = be(i, h, a * 2), r = be(r, o, a * 2), e.local.lastMousePos.x = i / t, e.local.lastMousePos.y = 1 - r / s), e.local.lastMousePos
    }
    setEffectPlaneUniforms(e, t) {
      var r, a, h;
      let s = ((r = t.local.stateEffectProps) == null ? void 0 : r.speed) ?? t.speed ?? 1;
      if (t.animating && e.uniforms.time && (e.uniforms.time.value += s * 60 / this.fps), Pe() && ((h = (a = this.interactivity) == null ? void 0 : a.mouse) != null && h.disableMobile)) return !1;
  ...
  function Qt() {
    te(window, "scroll", Qe), Pe() ? te(window, "touchmove", Re) : te(window, "mousemove", Re), te(window, "routeChange", Xe), te(document, "mouseleave", Ze), he = zt(Xt, 16), Pe() ? te(window, "orientationchange", he) : te(window, "resize", he), te(document, de, $e), Ce = !0
  }
